...
<p align="center">
  其他平台：<a href="https://github.com/CinderellaQAQ/pycharm-audiolens"><img src="https://cdn.simpleicons.org/pycharm/21D789" alt="" width="20" height="20"> <strong>AudioLens 的 PyCharm 版本</strong></a> · 由 <a href="https://github.com/CinderellaQAQ">@CinderellaQAQ</a> 维护
</p>
...
| 偏好保存 | 保存默认音轨视图、语谱图设置、PCM 默认参数和界面语言。 |
...
时间轴上的黄色标签显示保留三位小数的播放位置，可直接拖动定位。有选区时，拖动会保留选区并限制在选区内；播放中拖动会暂时暂停，松手后从新位置继续，拖到范围终点则保持暂停。
