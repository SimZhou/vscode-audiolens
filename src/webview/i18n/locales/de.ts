...
export const messages = {
  ...
  encodedPlaybackOnly: "Dieses codierte Audioformat wird vom VS Code Webview-Decoder nicht unterstützt. Installieren Sie FFmpeg auf dem Extension-Host, um Fallback-Decoding zu aktivieren.",
