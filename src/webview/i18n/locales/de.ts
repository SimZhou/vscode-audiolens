...
export const messages = {
  ...
  playbackMode: "Modus",
  playbackModeTitle: "Wiedergabemodus für decodiertes Audio",
  playbackDownmix: "Downmix",
  playbackBypass: "Bypass",
  playbackBypassFallback: "Bypass unterstützt nur Mono-/Stereo-Audio. Diese Datei wird per Downmix wiedergegeben.",
