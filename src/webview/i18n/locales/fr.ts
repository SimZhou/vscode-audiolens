...
export const messages = {
  ...
  playbackMode: "Mode",
  playbackModeTitle: "Mode de lecture de l'audio décodé",
  playbackDownmix: "Downmix",
  playbackBypass: "Bypass",
  playbackBypassFallback: "Le bypass ne prend en charge que l'audio mono/stéréo. Ce fichier sera lu en downmix.",
