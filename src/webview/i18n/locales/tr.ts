...
export const messages = {
  ...
  encodedPlaybackOnly: "Bu kodlanmış ses biçimi VS Code Webview decoder tarafından desteklenmiyor. Fallback decoding için extension host makinesine FFmpeg kurun.",
