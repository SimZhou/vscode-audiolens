...
export const messages = {
  ...
  encodedPlaybackOnly: "Dette kodede lydformatet støttes ikke av VS Code Webview-dekoderen. Installer FFmpeg på extension host-maskinen for fallback-dekoding.",
