...
export const messages = {
  ...
  playbackMode: "Modalità",
  playbackModeTitle: "Modalità di riproduzione per l'audio decodificato",
  playbackDownmix: "Downmix",
  playbackBypass: "Bypass",
  playbackBypassFallback: "Bypass supporta solo audio mono/stereo. Questo file verrà riprodotto con downmix.",
