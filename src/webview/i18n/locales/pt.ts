...
export const messages = {
  ...
  encodedPlaybackOnly: "Este formato de áudio codificado não é suportado pelo decodificador do VS Code Webview. Instale o FFmpeg na máquina do extension host para ativar a decodificação de fallback.",
