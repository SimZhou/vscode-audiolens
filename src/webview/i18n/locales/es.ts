...
export const messages = {
  ...
  encodedPlaybackOnly: "Este formato de audio codificado no es compatible con el decodificador del Webview de VS Code. Instala FFmpeg en la máquina del host de la extensión para activar la decodificación de respaldo.",
  ...
  playbackGain: "Ganancia de reproducción (doble clic para reiniciar)"
