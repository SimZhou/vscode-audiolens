...
export const messages = {
  ...
  playbackMode: "Modo",
  playbackModeTitle: "Modo de reproducción para audio decodificado",
  playbackDownmix: "Downmix",
  playbackBypass: "Bypass",
  playbackBypassFallback: "Bypass solo admite audio mono/estéreo. Este archivo se reproducirá con downmix.",
