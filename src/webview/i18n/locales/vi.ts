...
export const messages = {
  ...
  encodedPlaybackOnly: "Định dạng âm thanh mã hóa này không được bộ giải mã VS Code Webview hỗ trợ. Cài FFmpeg trên máy extension host để bật giải mã dự phòng.",
