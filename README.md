...
<p align="center">
  Other platforms: <a href="https://github.com/CinderellaQAQ/pycharm-audiolens"><strong>AudioLens for PyCharm</strong></a> · maintained by <a href="https://github.com/CinderellaQAQ">@CinderellaQAQ</a>
</p>
...
| Multi-channel audio | Audacity-style channel tracks, per-channel waveform/spectrogram views, mute, solo, and per-channel gain/pan playback. Stereo audio starts with channel 1 fully left and channel 2 fully right; mono and audio with three or more channels keep the centered downmix. Per-channel frequency scale/range and amplitude, with axis ticks that adapt to track height. |
...
```bash
# Download audiolens-<version>.vsix from https://github.com/SimZhou/vscode-audiolens/releases
...
| --- | --- | --- |
| WAV | `.wav` | Supports multi-channel WAV files, PCM WAV below 3000 Hz with native-rate analysis, ordered RIFF chunk inspection, standard 44-byte PCM header checks, and optional one-time PCM reread. |
