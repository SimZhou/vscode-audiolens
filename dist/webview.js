"use strict";(()=>{function se(n,e){return n===0&&e>0||n===4294967295||n>e?e:n}function Fe(n){let e=Math.max(0,n.duration),t=Math.max(1,n.sampleRate),a=Math.max(1,n.timeZoom),i=N(n.timeOffset,0,1),s=e/a,r=Math.max(0,e-s)*i,l=Math.min(e,r+s);return{startSample:Math.floor(r*t),endSample:Math.floor(l*t),startTime:r,endTime:l}}function H(n,e){let t=N(Number.isFinite(n)?n:-96,-160,-1),a=N(Number.isFinite(e)?e:0,-80,24);return{minDb:t,maxDb:Math.max(a,t+1)}}function Re(n){return[n.channel,n.startSample,n.endSample,n.fftSize,n.windowFunction,n.zeroPaddingFactor??1,n.outputBins??0,n.targetFrames??0,n.hopSize??0,n.minDb,n.maxDb,n.spectrogramMinHz??0,n.spectrogramMaxHz??0,n.frequencyScale??"linear",n.palette??"classic"].join(":")}function He(n,e,t,a){let i=new Float32Array(a),s=new Float32Array(a);if(a<=0||n.length===0)return{min:i,max:s};let o=N(Math.floor(e),0,n.length),r=N(Math.ceil(t),o,n.length),l=Math.max(1,r-o);for(let d=0;d<a;d+=1){let c=Math.min(r-1,o+Math.floor(d*l/a)),u=Math.min(r,Math.max(c+1,o+Math.ceil((d+1)*l/a))),p=0,g=0,f=!1;for(let b=c;b<u;b+=1){let y=n[b]??0;p=f?Math.min(p,y):y,g=f?Math.max(g,y):y,f=!0}i[d]=p,s[d]=g}return{min:i,max:s}}function N(n,e,t){return Math.max(e,Math.min(t,n))}function re(n,e={}){let t=e.min??2,a=e.max??8,i=Math.round((Number.isFinite(n)?n:0)/44),s=Math.min(a,Math.max(t,i));return e.even&&s%2!==0&&(s=Math.max(t,s-1)),s}function K(n){let e=Math.max(0,Number.isFinite(n)?n:0);if(e>=1e3){let t=e/1e3;return`${t>=100?Math.round(t):Math.round(t*10)/10}k`}return`${Math.round(e)}`}var _=1e-6;function $(n,e,t,a,i){let s=Math.max(_,i-a),o=Math.max(_,n.max-n.min),r=Math.min(s,Math.max(_,o*t)),l=Math.min(n.max,Math.max(n.min,e)),d=(l-n.min)/o,c=l-d*r,u=c+r;return c<a&&(c=a,u=a+r),u>i&&(u=i,c=i-r),{min:Math.max(a,c),max:Math.min(i,u)}}function oe(n,e,t,a){let i=Math.max(_,n.max-n.min),s=Math.max(t,a-i),o=Math.min(s,Math.max(t,n.min+e));return{min:o,max:o+i}}var Ct=`
  ...
  `;function V(){let n=URL.createObjectURL(new Blob([Ct],{type:"text/javascript"})),e=new Worker(n);return URL.revokeObjectURL(n),e}function Le(n,e){let t=e.toLowerCase().split(".").pop();return t==="wav"||t==="wave"?{sampleRate:zt(n)}:t==="flac"?{sampleRate:Et(n)}:{}}function Ie(n,e){let t=e.toLowerCase().split(".").pop();if(t==="wav"||t==="wave")return Tt(n);if(t==="flac")return Lt(n);if(t==="ogg"||t==="opus")return Dt(n);if(t==="m4a"||t==="mp4")return Be(n);if(t==="aac")return Vt(n)??Be(n);if(t==="mp3")return Gt(n)}function zt(n){if(n.byteLength<28||S(n,0,4)!=="RIFF"||S(n,8,12)!=="WAVE")return;let e=new DataView(n.buffer,n.byteOffset,n.byteLength),t=12;for(;t+8<=n.byteLength;){let a=S(n,t,t+4),i=e.getUint32(t+4,!0),s=t+8;if(a==="fmt "&&s+8<=n.byteLength){let o=e.getUint32(s+4,!0);return o>0?o:void 0}t=s+i+i%2}}function Tt(n){if(n.byteLength<12||S(n,0,4)!=="RIFF"||S(n,8,12)!=="WAVE")return;let e=new DataView(n.buffer,n.byteOffset,n.byteLength),t=[{offset:0,size:4,field:"ChunkID",value:S(n,0,4),note:"RIFF"},{offset:4,size:4,field:"ChunkSize",value:`${e.getUint32(4,!0)} B`,note:"\u6587\u4EF6\u5927\u5C0F - 8"},{offset:8,size:4,field:"Format",value:S(n,8,12),note:"WAVE"}],a=12,i,s,o,r=[];for(;a+8<=n.byteLength;){let l=S(n,a,a+4),d=l.trimEnd()||l,c=e.getUint32(a+4,!0),u=a+8,p=Math.min(u+c,n.byteLength);t.push({offset:a,size:4,field:`${d}.ChunkID`,value:l,note:"\u5B50\u5757 ID"}),t.push({offset:a+4,size:4,field:`${d}.ChunkSize`,value:`${c} B`,note:"\u5B50\u5757\u6570\u636E\u957F\u5EA6"}),l==="fmt "?(s=c,u+2<=p&&(o=e.getUint16(u,!0)),Bt(t,e,u,p)):l==="data"?(i=u,t.push({offset:u,size:c,field:"data.Payload",value:"",note:"\u97F3\u9891\u6570\u636E\u533A\u57DF"})):c>0&&(i===void 0&&r.push(d),t.push({offset:u,size:c,field:`${d}.Payload`,value:`${c} B`,note:"\u672A\u5C55\u5F00\u5B50\u5757"})),a=u+c+c%2}return{format:"WAV / RIFF",summary:Ft(i,s,o,r),rows:t}}function Ft(n,e,t,a){if(n===void 0)return{tone:"warning",kind:"wavHeader",missingData:!0,text:"\u672A\u627E\u5230 data chunk",detail:"\u65E0\u6CD5\u5224\u65AD WAV \u5934\u957F\u5EA6\u3002"};if(n===44&&e===16&&t===1)return{tone:"info",kind:"wavHeader",headerSize:n,standard:!0,text:`WAV \u5934\u957F\u5EA6 ${n} B`,detail:"\u6807\u51C6 44 \u5B57\u8282 PCM \u5934\u3002"};let s=Rt(e,t,a);return{tone:"warning",kind:"wavHeader",headerSize:n,standard:!1,reasons:s,text:`WAV \u5934\u957F\u5EA6 ${n} B`,detail:Ht(s).join("\uFF1B")}}function Rt(n,e,t){let a=[];return n!==void 0&&n!==16&&a.push({type:"fmtExtended",size:n}),e!==void 0&&e!==1&&a.push({type:"format",format:e,name:De(e)}),t.length>0&&a.push({type:"extraChunks",chunks:t}),a}function Ht(n){return n.map(e=>{switch(e.type){case"fmtExtended":return`fmt \u5B50\u5757\u4E3A ${e.size} B\uFF0C\u5305\u542B\u6269\u5C55\u683C\u5F0F\u5B57\u6BB5`;case"format":return`\u7F16\u7801\u683C\u5F0F\u4E3A ${e.format} (${e.name})`;case"extraChunks":return`data \u524D\u6709\u989D\u5916\u5B50\u5757 ${e.chunks.join(", ")}`;case"dataOffset":return"data \u8D77\u59CB\u504F\u79FB\u4E0D\u662F 44 B"}})}function Bt(n,e,t,a){if(t+16>a){n.push({offset:t,size:Math.max(0,a-t),field:"fmt.Payload",value:"\u4E0D\u5B8C\u6574",note:"fmt \u5B50\u5757\u8FC7\u77ED"});return}let i=e.getUint16(t,!0),s=e.getUint16(t+2,!0),o=e.getUint32(t+4,!0),r=e.getUint32(t+8,!0),l=e.getUint16(t+12,!0),d=e.getUint16(t+14,!0);n.push({offset:t,size:2,field:"fmt.AudioFormat",value:`${i} (${De(i)})`,note:"\u7F16\u7801\u683C\u5F0F"}),n.push({offset:t+2,size:2,field:"fmt.NumChannels",value:String(s),note:"\u901A\u9053\u6570"}),n.push({offset:t+4,size:4,field:"fmt.SampleRate",value:`${o} Hz`,note:"\u91C7\u6837\u7387"}),n.push({offset:t+8,size:4,field:"fmt.ByteRate",value:`${r} B/s`,note:"\u5B57\u8282\u7387"}),n.push({offset:t+12,size:2,field:"fmt.BlockAlign",value:`${l} B`,note:"\u6BCF\u5E27\u5B57\u8282\u6570"}),n.push({offset:t+14,size:2,field:"fmt.BitsPerSample",value:`${d} bit`,note:"\u4F4D\u6DF1"}),t+18<=a&&n.push({offset:t+16,size:2,field:"fmt.CbSize",value:`${e.getUint16(t+16,!0)} B`,note:"\u6269\u5C55\u53C2\u6570\u957F\u5EA6"}),t+24<=a&&i===65534&&(n.push({offset:t+18,size:2,field:"fmt.ValidBitsPerSample",value:`${e.getUint16(t+18,!0)} bit`,note:"\u6709\u6548\u4F4D\u6DF1"}),n.push({offset:t+20,size:4,field:"fmt.ChannelMask",value:`0x${e.getUint32(t+20,!0).toString(16)}`,note:"\u58F0\u9053\u5E03\u5C40\u63A9\u7801"}))}function De(n){switch(n){case 1:return"PCM";case 3:return"IEEE Float";case 6:return"A-law";case 7:return"Mu-law";case 65534:return"Extensible";default:return"Unknown"}}function Et(n){if(n.byteLength<42||S(n,0,4)!=="fLaC")return;let e=n[4]&127,t=n[5]<<16|n[6]<<8|n[7];if(e!==0||t<34||n.byteLength<42)return;let a=8,i=n[a+10]<<12|n[a+11]<<4|n[a+12]>>4;return i>0?i:void 0}function Lt(n){if(n.byteLength<4||S(n,0,4)!=="fLaC")return;let e=[{offset:0,size:4,field:"Marker",value:"fLaC",note:"FLAC \u6807\u8BC6"}],t=4;for(;t+4<=n.byteLength;){let a=n[t]??0,i=(a&128)!==0,s=a&127,o=de(n,t+1),r=t+4,l=Zt(s);if(e.push({offset:t,size:1,field:`${l}.Header`,value:`last=${i}, type=${s}`,note:"\u5143\u6570\u636E\u5757\u5934"}),e.push({offset:t+1,size:3,field:`${l}.Length`,value:`${o} B`,note:"\u5143\u6570\u636E\u5757\u957F\u5EA6"}),s===0&&r+34<=n.byteLength?It(e,n,r):o>0&&e.push({offset:r,size:o,field:`${l}.Payload`,value:`${o} B`,note:"\u5143\u6570\u636E\u5757\u5185\u5BB9"}),t=r+o,i)break}return{format:"FLAC",rows:e}}function It(n,e,t){let a=Ee(e,t),i=Ee(e,t+2),s=de(e,t+4),o=de(e,t+7),r=e[t+10]<<12|e[t+11]<<4|e[t+12]>>4,l=(e[t+12]>>1&7)+1,d=((e[t+12]&1)<<4|e[t+13]>>4)+1,c=(BigInt(e[t+13]&15)<<32n|BigInt(e[t+14])<<24n|BigInt(e[t+15])<<16n|BigInt(e[t+16])<<8n|BigInt(e[t+17])).toString();n.push({offset:t,size:2,field:"STREAMINFO.MinBlockSize",value:String(a),note:"\u6700\u5C0F\u5757\u5927\u5C0F"}),n.push({offset:t+2,size:2,field:"STREAMINFO.MaxBlockSize",value:String(i),note:"\u6700\u5927\u5757\u5927\u5C0F"}),n.push({offset:t+4,size:3,field:"STREAMINFO.MinFrameSize",value:`${s} B`,note:"\u6700\u5C0F\u5E27\u5927\u5C0F"}),n.push({offset:t+7,size:3,field:"STREAMINFO.MaxFrameSize",value:`${o} B`,note:"\u6700\u5927\u5E27\u5927\u5C0F"}),n.push({offset:t+10,size:3,bits:"80-99 (20 bit)",field:"STREAMINFO.SampleRate",value:`${r} Hz`,note:"\u91C7\u6837\u7387"}),n.push({offset:t+12,size:1,bits:"100-102 (3 bit)",field:"STREAMINFO.Channels",value:String(l),note:"\u901A\u9053\u6570"}),n.push({offset:t+12,size:2,bits:"103-107 (5 bit)",field:"STREAMINFO.BitsPerSample",value:`${d} bit`,note:"\u4F4D\u6DF1"}),n.push({offset:t+13,size:5,bits:"108-143 (36 bit)",field:"STREAMINFO.TotalSamples",value:c,note:"\u603B\u91C7\u6837\u6570"}),n.push({offset:t+18,size:16,field:"STREAMINFO.MD5",value:We(e,t+18,t+34),note:"\u539F\u59CB\u97F3\u9891 MD5"})}function Dt(n){if(n.byteLength<27||S(n,0,4)!=="OggS")return;let e=new DataView(n.buffer,n.byteOffset,n.byteLength),t=[],a=0,i=0;for(;a+27<=n.byteLength&&i<4&&S(n,a,a+4)==="OggS";){let s=n[a+26]??0;if(a+27+s>n.byteLength)break;let o=Ut(n,a+27,a+27+s),r=`Page${i}`;t.push({offset:a,size:4,field:`${r}.CapturePattern`,value:"OggS",note:"Ogg \u9875\u6807\u8BC6"}),t.push({offset:a+4,size:1,field:`${r}.Version`,value:String(n[a+4]??0),note:"\u6D41\u7ED3\u6784\u7248\u672C"}),t.push({offset:a+5,size:1,field:`${r}.HeaderType`,value:_t(n[a+5]??0),note:"\u9875\u7C7B\u578B\u6807\u5FD7"}),t.push({offset:a+6,size:8,field:`${r}.GranulePosition`,value:e.getBigUint64(a+6,!0).toString(),note:"\u7EDD\u5BF9\u4F4D\u7F6E"}),t.push({offset:a+14,size:4,field:`${r}.BitstreamSerialNumber`,value:String(e.getUint32(a+14,!0)),note:"\u903B\u8F91\u6D41\u5E8F\u53F7"}),t.push({offset:a+18,size:4,field:`${r}.PageSequenceNumber`,value:String(e.getUint32(a+18,!0)),note:"\u9875\u5E8F\u53F7"}),t.push({offset:a+22,size:4,field:`${r}.Checksum`,value:`0x${e.getUint32(a+22,!0).toString(16)}`,note:"\u9875\u6821\u9A8C\u548C"}),t.push({offset:a+26,size:1,field:`${r}.PageSegments`,value:String(s),note:"segment \u6570"}),t.push({offset:a+27,size:s,field:`${r}.SegmentTable`,value:`${s} B`,note:"segment \u957F\u5EA6\u8868"}),t.push({offset:a+27+s,size:o,field:`${r}.Payload`,value:`${o} B`,note:"\u9875\u6570\u636E"}),i===0&&qt(t,n,a+27+s,o),a+=27+s+o,i+=1}return{format:"OGG",rows:t}}function qt(n,e,t,a){if(a>=19&&S(e,t,t+8)==="OpusHead"){n.push({offset:t,size:8,field:"OpusHead.Magic",value:"OpusHead",note:"Opus \u8BC6\u522B\u5934"}),n.push({offset:t+8,size:1,field:"OpusHead.Version",value:String(e[t+8]??0),note:"\u7248\u672C"}),n.push({offset:t+9,size:1,field:"OpusHead.ChannelCount",value:String(e[t+9]??0),note:"\u901A\u9053\u6570"}),n.push({offset:t+10,size:2,field:"OpusHead.PreSkip",value:String(Ne(e,t+10)),note:"\u9884\u8DF3\u8FC7\u91C7\u6837\u6570"}),n.push({offset:t+12,size:4,field:"OpusHead.InputSampleRate",value:`${le(e,t+12)} Hz`,note:"\u8F93\u5165\u91C7\u6837\u7387"}),n.push({offset:t+16,size:2,field:"OpusHead.OutputGain",value:String(Ot(e,t+16)),note:"\u8F93\u51FA\u589E\u76CA"}),n.push({offset:t+18,size:1,field:"OpusHead.ChannelMappingFamily",value:String(e[t+18]??0),note:"\u58F0\u9053\u6620\u5C04\u65CF"});return}a>=30&&e[t]===1&&S(e,t+1,t+7)==="vorbis"&&(n.push({offset:t,size:1,field:"Vorbis.PacketType",value:"1",note:"\u8BC6\u522B\u5934"}),n.push({offset:t+1,size:6,field:"Vorbis.Magic",value:"vorbis",note:"Vorbis \u6807\u8BC6"}),n.push({offset:t+7,size:4,field:"Vorbis.Version",value:String(le(e,t+7)),note:"\u7248\u672C"}),n.push({offset:t+11,size:1,field:"Vorbis.Channels",value:String(e[t+11]??0),note:"\u901A\u9053\u6570"}),n.push({offset:t+12,size:4,field:"Vorbis.SampleRate",value:`${le(e,t+12)} Hz`,note:"\u91C7\u6837\u7387"}))}function Be(n){if(n.byteLength<8)return;let e=[];return qe(e,n,0,n.byteLength,0),e.length>0?{format:"M4A / MP4",rows:e}:void 0}function qe(n,e,t,a,i){let s=Wt(e,t,a);s.forEach((o,r)=>{if(n.length>=420)return;let l=r===s.length-1;n.push({offset:o.offset,size:o.boxSize,depth:i,treePrefix:l?"\u2514\u2500":"\u251C\u2500",kind:"box",field:o.type,value:"",note:"box \u7C7B\u578B"});let d=o.offset+o.headerSize,c=o.offset+o.boxSize;if(Nt(n,e,o.type,d,c,i+1,l),$t(o.type)){let u=o.type==="meta"?d+4:d;u<=c&&qe(n,e,u,c,i+1)}})}function Wt(n,e,t){let a=[],i=e;for(;i+8<=t&&a.length<420;){let s=B(n,i),o=S(n,i+4,i+8);if(!Kt(o))break;let r=8,l=s;if(s===1&&i+16<=t?(l=Number(Ve(n,i+8)),r=16):s===0&&(l=t-i),l<r||i+l>t)break;a.push({offset:i,type:o,boxSize:l,headerSize:r}),i+=l}return a}function Nt(n,e,t,a,i,s,o){let r=o?"  \u251C\u2500":"\u2502 \u251C\u2500";if(t==="ftyp"&&a+8<=i){n.push({offset:a,size:4,depth:s,treePrefix:r,kind:"field",field:"MajorBrand",value:S(e,a,a+4),note:"\u4E3B\u54C1\u724C"}),n.push({offset:a+4,size:4,depth:s,treePrefix:r,kind:"field",field:"MinorVersion",value:String(B(e,a+4)),note:"\u6B21\u7248\u672C"}),a+8<i&&n.push({offset:a+8,size:i-a-8,depth:s,treePrefix:r,kind:"field",field:"CompatibleBrands",value:Xt(e,a+8,i),note:"\u517C\u5BB9\u54C1\u724C"});return}if((t==="mvhd"||t==="mdhd")&&a+20<=i){let l=e[a]??0;n.push({offset:a,size:1,depth:s,treePrefix:r,kind:"field",field:"Version",value:String(l),note:"\u7248\u672C"}),n.push({offset:a+1,size:3,depth:s,treePrefix:r,kind:"field",field:"Flags",value:`0x${We(e,a+1,a+4)}`,note:"\u6807\u5FD7"}),l===1&&a+32<=i?(n.push({offset:a+20,size:4,depth:s,treePrefix:r,kind:"field",field:"Timescale",value:String(B(e,a+20)),note:"\u65F6\u95F4\u523B\u5EA6"}),n.push({offset:a+24,size:8,depth:s,treePrefix:r,kind:"field",field:"Duration",value:Ve(e,a+24).toString(),note:"\u65F6\u957F\u5355\u4F4D\u6570"})):a+20<=i&&(n.push({offset:a+12,size:4,depth:s,treePrefix:r,kind:"field",field:"Timescale",value:String(B(e,a+12)),note:"\u65F6\u95F4\u523B\u5EA6"}),n.push({offset:a+16,size:4,depth:s,treePrefix:r,kind:"field",field:"Duration",value:String(B(e,a+16)),note:"\u65F6\u957F\u5355\u4F4D\u6570"}));return}if(t==="hdlr"&&a+12<=i){n.push({offset:a,size:1,depth:s,treePrefix:r,kind:"field",field:"Version",value:String(e[a]??0),note:"\u7248\u672C"}),n.push({offset:a+8,size:4,depth:s,treePrefix:r,kind:"field",field:"HandlerType",value:S(e,a+8,a+12),note:"\u5904\u7406\u5668\u7C7B\u578B"});return}t==="stsd"&&a+16<=i&&(n.push({offset:a,size:1,depth:s,treePrefix:r,kind:"field",field:"Version",value:String(e[a]??0),note:"\u7248\u672C"}),n.push({offset:a+4,size:4,depth:s,treePrefix:r,kind:"field",field:"EntryCount",value:String(B(e,a+4)),note:"\u6837\u672C\u63CF\u8FF0\u6570\u91CF"}),n.push({offset:a+12,size:4,depth:s,treePrefix:r,kind:"field",field:"SampleEntryType",value:S(e,a+12,a+16),note:"\u6837\u672C\u7C7B\u578B"}))}function Vt(n){if(n.byteLength<7||n[0]!==255||((n[1]??0)&240)!==240)return;let e=n[1]&1,t=n[2]>>6&3,a=n[2]>>2&15,i=(n[2]&1)<<2|n[3]>>6&3,s=(n[3]&3)<<11|n[4]<<3|n[5]>>5&7,o=(n[5]&31)<<6|n[6]>>2&63,r=n[6]&3;return{format:"AAC / ADTS",rows:[{offset:0,size:2,bits:"0-11 (12 bit)",field:"ADTS.Syncword",value:"0xfff",note:"\u540C\u6B65\u5B57"},{offset:1,size:1,bits:"12 (1 bit)",field:"ADTS.MpegVersion",value:(n[1]>>3&1)===0?"MPEG-4":"MPEG-2",note:"MPEG \u7248\u672C"},{offset:1,size:1,bits:"13-14 (2 bit)",field:"ADTS.Layer",value:String(n[1]>>1&3),note:"\u5C42"},{offset:1,size:1,bits:"15 (1 bit)",field:"ADTS.ProtectionAbsent",value:String(e),note:"CRC \u662F\u5426\u7701\u7565"},{offset:2,size:1,bits:"16-17 (2 bit)",field:"ADTS.Profile",value:`${t} (${Yt(t)})`,note:"AAC profile"},{offset:2,size:1,bits:"18-21 (4 bit)",field:"ADTS.SamplingFrequencyIndex",value:`${a} (${Qt(a)})`,note:"\u91C7\u6837\u7387\u7D22\u5F15"},{offset:2,size:2,bits:"23-25 (3 bit)",field:"ADTS.ChannelConfiguration",value:String(i),note:"\u58F0\u9053\u914D\u7F6E"},{offset:3,size:3,bits:"30-42 (13 bit)",field:"ADTS.FrameLength",value:`${s} B`,note:"ADTS \u5E27\u957F\u5EA6"},{offset:5,size:2,bits:"43-53 (11 bit)",field:"ADTS.BufferFullness",value:String(o),note:"\u7F13\u51B2 fullness"},{offset:6,size:1,bits:"54-55 (2 bit)",field:"ADTS.RawDataBlocks",value:String(r),note:"\u539F\u59CB\u6570\u636E\u5757\u6570\u91CF\u5B57\u6BB5"}]}}function Gt(n){let e=[],t=0;if(n.byteLength>=10&&S(n,0,3)==="ID3"){let a=jt(n,6);e.push({offset:0,size:3,field:"ID3.Identifier",value:"ID3",note:"ID3v2 \u6807\u8BC6"}),e.push({offset:3,size:2,field:"ID3.Version",value:`${n[3]??0}.${n[4]??0}`,note:"ID3 \u7248\u672C"}),e.push({offset:5,size:1,field:"ID3.Flags",value:`0x${(n[5]??0).toString(16)}`,note:"\u6807\u5FD7"}),e.push({offset:6,size:4,field:"ID3.Size",value:`${a} B`,note:"\u6807\u7B7E\u957F\u5EA6"}),t=10+a}for(;t+4<=n.byteLength&&!(n[t]===255&&((n[t+1]??0)&224)===224);)t+=1;return t+4>n.byteLength?e.length>0?{format:"MP3",rows:e}:void 0:(e.push({offset:t,size:2,bits:"frame 0-10 (11 bit)",field:"MPEG.Sync",value:"0x7ff",note:"\u5E27\u540C\u6B65"}),e.push({offset:t+1,size:1,bits:"frame 11-12 (2 bit)",field:"MPEG.Version",value:Jt(n[t+1]>>3&3),note:"MPEG \u97F3\u9891\u7248\u672C"}),e.push({offset:t+1,size:1,bits:"frame 13-14 (2 bit)",field:"MPEG.Layer",value:ea(n[t+1]>>1&3),note:"Layer"}),e.push({offset:t+1,size:1,bits:"frame 15 (1 bit)",field:"MPEG.ProtectionBit",value:String(n[t+1]&1),note:"CRC \u6807\u5FD7"}),e.push({offset:t+2,size:1,bits:"frame 16-19 (4 bit)",field:"MPEG.BitrateIndex",value:String(n[t+2]>>4&15),note:"\u7801\u7387\u7D22\u5F15"}),e.push({offset:t+2,size:1,bits:"frame 20-21 (2 bit)",field:"MPEG.SamplingRateIndex",value:String(n[t+2]>>2&3),note:"\u91C7\u6837\u7387\u7D22\u5F15"}),e.push({offset:t+3,size:1,bits:"frame 24-25 (2 bit)",field:"MPEG.ChannelMode",value:ta(n[t+3]>>6&3),note:"\u58F0\u9053\u6A21\u5F0F"}),{format:"MP3",rows:e})}function S(n,e,t){let a="";for(let i=e;i<t;i+=1)a+=String.fromCharCode(n[i]??0);return a}function We(n,e,t){let a="";for(let i=e;i<t;i+=1)a+=(n[i]??0).toString(16).padStart(2,"0");return a}function Ee(n,e){return(n[e]??0)<<8|(n[e+1]??0)}function Ne(n,e){return(n[e]??0)|(n[e+1]??0)<<8}function Ot(n,e){let t=Ne(n,e);return t>=32768?t-65536:t}function de(n,e){return(n[e]??0)<<16|(n[e+1]??0)<<8|(n[e+2]??0)}function B(n,e){return(n[e]??0)*16777216+((n[e+1]??0)<<16|(n[e+2]??0)<<8|(n[e+3]??0))}function le(n,e){return(n[e]??0)|(n[e+1]??0)<<8|(n[e+2]??0)<<16|(n[e+3]??0)*16777216}function Ve(n,e){return BigInt(n[e]??0)<<56n|BigInt(n[e+1]??0)<<48n|BigInt(n[e+2]??0)<<40n|BigInt(n[e+3]??0)<<32n|BigInt(n[e+4]??0)<<24n|BigInt(n[e+5]??0)<<16n|BigInt(n[e+6]??0)<<8n|BigInt(n[e+7]??0)}function jt(n,e){return(n[e]&127)<<21|(n[e+1]&127)<<14|(n[e+2]&127)<<7|n[e+3]&127}function Ut(n,e,t){let a=0;for(let i=e;i<t;i+=1)a+=n[i]??0;return a}function Zt(n){return["STREAMINFO","PADDING","APPLICATION","SEEKTABLE","VORBIS_COMMENT","CUESHEET","PICTURE"][n]??`BLOCK_${n}`}function _t(n){let e=[];return(n&1)!==0&&e.push("continued"),(n&2)!==0&&e.push("first"),(n&4)!==0&&e.push("last"),e.length?`${n} (${e.join(", ")})`:String(n)}function Kt(n){return/^[A-Za-z0-9 _-]{4}$/.test(n)}function $t(n){return["moov","trak","mdia","minf","stbl","edts","udta","meta","ilst"].includes(n)}function Xt(n,e,t){let a=[];for(let i=e;i+4<=t;i+=4)a.push(S(n,i,i+4));return a.join(", ")}function Yt(n){return["Main","LC","SSR","Reserved"][n]??"Unknown"}function Qt(n){return["96000 Hz","88200 Hz","64000 Hz","48000 Hz","44100 Hz","32000 Hz","24000 Hz","22050 Hz","16000 Hz","12000 Hz","11025 Hz","8000 Hz","7350 Hz"][n]??"reserved"}function Jt(n){return["MPEG 2.5","reserved","MPEG 2","MPEG 1"][n]??"unknown"}function ea(n){return["reserved","Layer III","Layer II","Layer I"][n]??"unknown"}function ta(n){return["Stereo","Joint stereo","Dual channel","Single channel"][n]??"unknown"}function m(n,e){let t=document.querySelector(n);if(!(t instanceof e))throw new Error(`Missing element: ${n}`);return t}function E(n){let e=n.getBoundingClientRect(),t=window.devicePixelRatio||1,a=Math.max(1,Math.floor(e.width*t)),i=Math.max(1,Math.floor(e.height*t));(n.width!==a||n.height!==i)&&(n.width=a,n.height=i);let s=n.getContext("2d",{alpha:!1});if(!s)throw new Error("Canvas 2D context unavailable");return s}function ce(n){let e=Math.floor(n/60),t=Math.floor(n%60),a=Math.floor((n-Math.floor(n))*1e3);return`${e}:${String(t).padStart(2,"0")}.${String(a).padStart(3,"0")}`}function ue(n){if(n<1024)return`${n} B`;let e=["KB","MB","GB"],t=n/1024,a=0;for(;t>=1024&&a<e.length-1;)t/=1024,a+=1;return`${t.toFixed(t>=10?1:2)} ${e[a]}`}function h(n,e,t){return Math.max(e,Math.min(t,n))}var Ge={waitingAudioFile:"Warte auf Audiodatei",initializing:"Initialisierung",spectrogramSettings:"Spectrogram-Einstellungen",playPause:"Wiedergabe / Pause",playbackPosition:"Wiedergabeposition",closeSettings:"Einstellungen schliessen",spectrogramDisplay:"Spectrogram-Anzeige",algorithmFrequency:"Frequenz",windowSize:"Fenstergroesse",windowType:"Fenstertyp",windowRectangular:"Rechteck",windowBartlett:"Bartlett",windowHamming:"Hamming",windowHann:"Hann",windowBlackman:"Blackman",windowBlackmanHarris:"Blackman-Harris",windowWelch:"Welch",windowGaussian25:"Gauss (\u03B1=2.5)",windowGaussian35:"Gauss (\u03B1=3.5)",windowGaussian45:"Gauss (\u03B1=4.5)",zeroPaddingFactor:"Null-Padding-Faktor",frequencyScale:"Frequenzskala",frequencyRange:"Frequenzbereich (nur Anzeige)",minFrequencyHz:"Min. Frequenz (Hz)",maxFrequencyHz:"Max. Frequenz (Hz)",maxFrequencyNyquist:"Max folgt Nyquist",spectrogramAppearance:"Spectrogram-Darstellung",palette:"Palette",paletteRose:"Rose",paletteClassic:"Klassisch",paletteGrayscale:"Graustufen",paletteInverseGrayscale:"Inverse Graustufen",minDb:"Min. dB (Helligkeit)",maxDb:"Max. dB (Helligkeit)",autoBrightness:"Auto-Helligkeit",amplitudeRange:"Amplitudenbereich (Wellenform)",minAmplitude:"Min. Amplitude",maxAmplitude:"Max. Amplitude",amplitudeAuto:"Auto (pro Kanal)",channel:"Kanal",timeZoom:"Zeitzoom",timePosition:"Zeitposition",mouseWheel:"Mausrad",help:"Hilfe",downloadAudio:"Audio herunterladen",downloadSelection:"Auswahl herunterladen",downloadSelectionWav:"Auswahl als WAV herunterladen",clearSelection:"Auswahl loeschen",noSelectionToDownload:"Keine Audioauswahl zum Herunterladen",headerInfo:"Header-Info",headerInfoTitle:"Header-Info",headerInfoAudioUnread:"Audiodaten wurden noch nicht gelesen.",headerInfoUnsupported:"Header-Parsing wird f\xFCr dieses Format noch nicht unterst\xFCtzt.",headerInfoOffset:"Offset",headerInfoByteOffset:"Byte-Offset",headerInfoSize:"L\xE4nge",headerInfoBits:"Bits",headerInfoField:"Feld",headerInfoValue:"Wert",headerInfoDescription:"Beschreibung",headerInfoWavMissingData:"data-Chunk nicht gefunden",headerInfoWavCannotDetermine:"WAV-Headerl\xE4nge kann nicht bestimmt werden.",headerInfoWavHeaderLength:"WAV-Headerl\xE4nge {size} B",headerInfoWavStandardPcm:"Standardm\xE4\xDFiger 44-Byte-PCM-Header.",headerInfoWavNonStandardPrefix:"Nicht standardm\xE4\xDFiger 44-Byte-PCM-Header",headerInfoWavFmtExtended:"fmt-Chunk ist {size} B gro\xDF und enth\xE4lt erweiterte Formatfelder",headerInfoWavFormat:"Audioformat ist {format} ({name})",headerInfoWavExtraChunks:"zus\xE4tzliche Chunks vor data: {chunks}",headerInfoWavDataOffsetNon44:"data beginnt nicht bei Offset 44 B",headerInfoReasonSeparator:"; ",arkOffsetLabel:"ARK-Offset",settings:"Einstellungen",pcmReadAs:"Als PCM lesen",pcmParams:"PCM-Dateiparameter",editPcmParams:"Parameter bearbeiten",wavPcmRead:"WAV als PCM lesen",currentFileOnly:"Nur aktuelle Datei",sampleRate:"Abtastrate",channels:"Kan\xE4le",startOffsetBytes:"Offset (B)",bitDepth:"Kodierung",sampleFormat:"Format",endianness:"Byte order",read:"Lesen",saveDefault:"Standard speichern",cancel:"Abbrechen",defaultView:"Standardansicht",view:"Ansicht",viewBoth:"Mehrfachansicht",mute:"Stumm",solo:"Solo",timeLabel:"Zeit",helpTimeZoom:"Zeitzoom",helpTimePan:"Zeit verschieben",helpAmplitudeZoom:"Amplitudenzoom",helpRightClick:"Rechtsklick",helpPinch:"Pinch",helpHorizontalSwipe:"Horizontal wischen",helpDoubleClick:"Doppelklick",helpPlaybackGroup:"Wiedergabe & Auswahl",helpViewGroup:"Ansichtsnavigation",helpMouseGroup:"Maus & Trackpad",helpGainGroup:"Gain & Panorama",helpPlayPause:"Wiedergabe / Pause",helpClearSelection:"Men\xFC schlie\xDFen, Auswahl l\xF6schen oder Wiedergabecursor zur\xFCcksetzen",helpResetTimeZoom:"Zeitzoom zur\xFCcksetzen",helpTrackpadZoom:"Mit Trackpad-Pinch die Zeit zoomen",helpTrackpadPan:"Horizontaler Trackpad-Swipe verschiebt die Zeit",helpGainReset:"Gain- oder Panorama-Regler doppelklicken, um ihn zur\xFCckzusetzen",helpSelectionPlayback:"Wellenform oder Spektrogramm ziehen, um einen Bereich auszuw\xE4hlen. Bei aktiver Auswahl wird nur dieser Bereich abgespielt.",refreshSpectrogram:"Spectrogram aktualisieren",resetView:"Ansicht zuruecksetzen",selectionAnalysis:"Auswahlanalyse",selectionStart:"Start",selectionEnd:"Ende",selectionDuration:"Dauer",rmsLevel:"RMS-Pegel",peakLevel:"Peak-Pegel",dominant:"Dominant",crestFactor:"Crest",clippingRatio:"Clipping",noiseFloor:"Noise Floor",spectralCentroid:"Zentroid",zeroCrossingRate:"ZCR",basicMetrics:"Basiswerte",selectionAnalysisHelp:`Auswahlanalyse:
...
\u8A08\u7B97\uFF1A
\u5C07\u9078\u5340\u5207\u6210 50% overlap \u7684 FFT frame\uFF0C\u7D2F\u7A4D\u5404 bin \u529F\u7387\u5F8C\u5206\u914D\u5230\u983B\u5E36\u4E26\u986F\u793A\u767E\u5206\u6BD4\u3002`,selectionAnalysisCalculating:"\u8A08\u7B97\u4E2D...",bands:"\u983B\u5E36",waveform:"\u6CE2\u5F62",spectrogram:"\u983B\u8B5C\u5716",adjustWaveformHeight:"\u8ABF\u6574\u6CE2\u5F62\u9AD8\u5EA6",adjustSpectrogramHeight:"\u8ABF\u6574\u983B\u8B5C\u5716\u9AD8\u5EA6",ready:"\u5C31\u7DD2",workspaceNotTrusted:"\u5DE5\u4F5C\u5340\u4E0D\u53D7\u4FE1\u4EFB",fileTooLarge:"\u6A94\u6848\u8D85\u904E\u9650\u5236",readingAudio:"\u8B80\u53D6\u97F3\u8A0A\u4E2D",readingAudioProgress:"\u8B80\u53D6\u97F3\u8A0A\u4E2D",decodingAudio:"\u89E3\u78BC\u97F3\u8A0A\u4E2D",transcodingAudio:"\u6B63\u5728\u4F7F\u7528 FFmpeg \u8F49\u78BC\u97F3\u8A0A",encodedPlaybackOnly:"\u97F3\u8A0A\u89E3\u78BC\u5931\u6557\u3002",emptyWavNoAudio:"WAV \u6A94\u6848\u4E0D\u5305\u542B\u97F3\u8A0A\u8CC7\u6599\u3002",waitingPcmParams:"\u7B49\u5F85 PCM \u53C3\u6578",pcmUsedDefaultParams:"\u5DF2\u4F7F\u7528\u9810\u8A2D PCM \u53C3\u6578\u8F09\u5165\u3002",pcmFillParams:"\u8ACB\u586B\u5BEB PCM \u53C3\u6578\uFF0C\u7136\u5F8C\u9EDE\u64CA\u8B80\u53D6\u3002",wavPcmFillParams:"\u8ACB\u586B\u5BEB\u53C3\u6578\uFF0C\u7136\u5F8C\u9EDE\u64CA\u8B80\u53D6\uFF0C\u5C07\u76EE\u524D WAV \u6309 PCM \u89E3\u6790\u3002",currentPcmFormat:"\u76EE\u524D",savedDefaultPcmFormat:"\u5DF2\u5132\u5B58\u9810\u8A2D",audioLoaded:"\u97F3\u8A0A\u5DF2\u8F09\u5165",audioNotReady:"\u97F3\u8A0A\u5C1A\u672A\u5C31\u7DD2",audioCannotPlay:"\u6B64\u97F3\u8A0A\u7121\u6CD5\u5728 Webview \u64AD\u653E",playbackFailed:"\u64AD\u653E\u5931\u6557",analyzingSpectrogram:"\u5206\u6790\u983B\u8B5C\u5716\u4E2D",frequencyBand0To250:"0-250",frequencyBand250To500:"250-500",frequencyBand500To1k:"0.5-1k",frequencyBand1To2k:"1-2k",frequencyBand2To4k:"2-4k",frequencyBand4To8k:"4-8k",frequencyBand8kPlus:"8k+",pad:"pad",hop:"hop",initializationFailed:"AudioLens \u521D\u59CB\u5316\u5931\u6557",trackGain:"\u589E\u76CA",trackPan:"\u8072\u9053\u5E73\u8861",panLeft:"\u5DE6",panRight:"\u53F3",panCenter:"\u4E2D",doubleClickReset:"\u96D9\u64CA\u91CD\u8A2D",freqScaleMenuTitle:"\u8A72\u901A\u9053\u983B\u7387\u523B\u5EA6",restoreChannelDefault:"\u6062\u5FA9\u8A72\u901A\u9053\u9810\u8A2D",helpAxisGroup:"\u7E31\u5411\u5EA7\u6A19\u8EF8",helpAxisZoom:"\u5EA7\u6A19\u8EF8\u4E0A Ctrl+\u6EFE\u8F2A / \u634F\u5408\uFF1A\u7E2E\u653E\u8A72\u8EF8\uFF08\u6BCF\u901A\u9053\uFF09",helpAxisPan:"\u5EA7\u6A19\u8EF8\u4E0A Shift+\u6EFE\u8F2A / \u6A6B\u5411\u6ED1\u52D5\uFF1A\u5E73\u79FB\u8A72\u8EF8\uFF08\u6BCF\u901A\u9053\uFF09",helpAxisAlt:"\u6CE2\u5F62\u5716\u4E0A Alt+\u6EFE\u8F2A\uFF1A\u7E2E\u653E\u8A72\u901A\u9053\u632F\u5E45",helpAxisScaleMenu:"\u983B\u7387\u8EF8\u53F3\u9375\uFF1A\u8A2D\u5B9A\u8A72\u901A\u9053\u523B\u5EA6\u985E\u578B",helpAxisReset:"\u5EA7\u6A19\u8EF8\u96D9\u64CA\uFF1A\u6062\u5FA9\u8A72\u901A\u9053\u9810\u8A2D"};var aa={"zh-CN":at,"zh-TW":nt,en:me,ja:_e,ko:Ke,fr:je,de:Ge,ru:Je,es:Oe,it:Ze,pt:Qe,id:Ue,no:Xe,nl:$e,pl:Ye,tr:et,vi:tt};function pe(n){return{...me,...aa[n]??{}}}function na(n){let e=(n||"en").toLowerCase();return e==="zh-tw"||e==="zh-hk"||e==="zh-hant"||e.startsWith("zh-hant")?"zh-TW":e==="zh-cn"||e==="zh-sg"||e==="zh-hans"||e.startsWith("zh")?"zh-CN":e.startsWith("ja")?"ja":e.startsWith("ko")?"ko":e.startsWith("fr")?"fr":e.startsWith("de")?"de":e.startsWith("ru")?"ru":e.startsWith("es")?"es":e.startsWith("it")?"it":e.startsWith("pt")?"pt":e.startsWith("id")?"id":e.startsWith("no")||e.startsWith("nb")||e.startsWith("nn")?"no":e.startsWith("nl")?"nl":e.startsWith("pl")?"pl":e.startsWith("tr")?"tr":e.startsWith("vi")?"vi":"en"}function it(n,e){return n&&n!=="auto"?n:na(e)}function he(n){return n!==void 0&&Number.isFinite(n)&&n>=3e3&&n<=768e3}function G(n){switch(n){case"signed-8":return{bitDepth:8,sampleFormat:"signed-int",endianness:"none"};case"signed-16":return{bitDepth:16,sampleFormat:"signed-int",endianness:"little"};case"signed-24":return{bitDepth:24,sampleFormat:"signed-int",endianness:"little"};case"signed-32":return{bitDepth:32,sampleFormat:"signed-int",endianness:"little"};case"unsigned-8":return{bitDepth:8,sampleFormat:"unsigned-int",endianness:"none"};case"float-64":return{bitDepth:64,sampleFormat:"float",endianness:"little"};default:return{bitDepth:32,sampleFormat:"float",endianness:"little"}}}function O(n){return n.sampleFormat==="float"?n.bitDepth===64?"float-64":"float-32":n.sampleFormat==="unsigned-int"?"unsigned-8":n.bitDepth===8?"signed-8":n.bitDepth===24?"signed-24":n.bitDepth===32?"signed-32":"signed-16"}function fe(n,e){let t=rt(e),a=ia(n,t),i=ye(t),s=st(t);if(i<=0||s<=0||a.byteLength%s!==0)throw new Error("PCM parameters do not match the file size.");let o=a.byteLength/s,r=Array.from({length:e.channels},()=>new Float32Array(o));for(let l=0;l<o;l+=1){let d=l*s;for(let c=0;c<e.channels;c+=1){let u=d+c*i;r[c][l]=sa(a,u,t)}}return{sampleRate:e.sampleRate,channels:r}}function ge(n,e){let t=e.channels[0]?.length??0,a=n.createBuffer(e.channels.length,t,e.sampleRate);return e.channels.forEach((i,s)=>a.getChannelData(s).set(i)),a}function be(n,e){let t=rt(e),a=e.startOffsetBytes??0;if(!he(e.sampleRate))return"PCM sample rate must be between 3000 and 768000 Hz.";if(!Number.isInteger(e.channels)||e.channels<=0||e.channels>32)return"PCM channel count must be between 1 and 32.";if(![8,16,24,32,64].includes(t.bitDepth))return"PCM encoding must be Signed 8/16/24/32-bit PCM, Unsigned 8-bit PCM, 32-bit float, or 64-bit float.";if(t.sampleFormat==="float"&&t.bitDepth!==32&&t.bitDepth!==64)return"Float PCM supports 32-bit or 64-bit only.";if(t.sampleFormat==="unsigned-int"&&t.bitDepth!==8)return"Unsigned PCM currently supports 8-bit only.";if(t.bitDepth>8&&t.endianness==="none")return"Byte order is required for multi-byte PCM encodings.";if(!Number.isInteger(a)||a<0)return"PCM start offset must be a non-negative integer.";if(a>=n.byteLength)return`PCM start offset ${a} bytes exceeds the file size.`;let i=n.byteLength-a,s=st(t);if(s<=0||i%s!==0)return`Data size after offset (${i} bytes) is not aligned to the current PCM parameters.`}function ia(n,e){return n.subarray(e.startOffsetBytes??0)}function sa(n,e,t){let a=new DataView(n.buffer,n.byteOffset+e,ye(t));if(t.sampleFormat==="float"){let i=t.endianness==="little";return oa(t.bitDepth===64?a.getFloat64(0,i):a.getFloat32(0,i),-1,1)}if(t.bitDepth===8)return t.sampleFormat==="unsigned-int"?(a.getUint8(0)-128)/128:a.getInt8(0)/128;if(t.bitDepth===16)return a.getInt16(0,t.endianness==="little")/32768;if(t.bitDepth===24){let s=t.endianness==="little"?a.getUint8(0)|a.getUint8(1)<<8|a.getUint8(2)<<16:a.getUint8(2)|a.getUint8(1)<<8|a.getUint8(0)<<16;return ra(s)/8388608}return a.getInt32(0,t.endianness==="little")/2147483648}function ra(n){return n&8388608?n|-16777216:n}function ye(n){return n.bitDepth/8}function st(n){return ye(n)*n.channels}function oa(n,e,t){return Math.max(e,Math.min(t,n))}function rt(n){let e=O(n),t=G(e),a=t.bitDepth===8?"none":n.endianness==="none"?t.endianness:n.endianness;return{...n,...t,endianness:a}}function ot(n){return n.innerHTML=`
    <main class="shell">
      <header class="topbar">
        <div class="identity">
  ...
  `,document.head.appendChild(n)}var ze=document.querySelector("#app");if(!ze)throw new Error("AudioLens root element missing");Mt();var Ce=acquireVsCodeApi();try{let n=new ae(Ce,ot(ze));window.addEventListener("message",e=>{n.handleMessage(e.data)}),Ce.postMessage({type:"ready"})}catch(n){let e=n instanceof Error?n.message:String(n);ze.textContent=`AudioLens initialization failed: ${e}`,Ce.postMessage({type:"showError",message:`AudioLens initialization failed: ${e}`})}})();
