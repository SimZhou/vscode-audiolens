"use strict";(()=>{function te(n,e){return n===0&&e>0||n===4294967295||n>e?e:n}function ze(n){let e=Math.max(0,n.duration),a=Math.max(1,n.sampleRate),t=Math.max(1,n.timeZoom),i=D(n.timeOffset,0,1),r=e/t,o=Math.max(0,e-r)*i,l=Math.min(e,o+r);return{startSample:Math.floor(o*a),endSample:Math.floor(l*a),startTime:o,endTime:l}}function q(n,e){let a=D(Number.isFinite(n)?n:-96,-160,-1),t=D(Number.isFinite(e)?e:0,-80,24);return{minDb:a,maxDb:Math.max(t,a+1)}}function Ae(n){return[n.channel,n.startSample,n.endSample,n.fftSize,n.windowFunction,n.algorithm??"frequency",n.zeroPaddingFactor??1,n.outputBins??0,n.targetFrames??0,n.hopSize??0,n.minDb,n.maxDb,n.spectrogramMinHz??0,n.spectrogramMaxHz??0,n.frequencyScale??"linear",n.palette??"classic"].join(":")}function Te(n,e,a,t){let i=new Float32Array(t),r=new Float32Array(t);if(t<=0||n.length===0)return{min:i,max:r};let s=D(Math.floor(e),0,n.length),o=D(Math.ceil(a),s,n.length),l=Math.max(1,o-s);for(let d=0;d<t;d+=1){let c=Math.min(o-1,s+Math.floor(d*l/t)),u=Math.min(o,Math.max(c+1,s+Math.ceil((d+1)*l/t))),p=0,g=0,h=!1;for(let y=c;y<u;y+=1){let k=n[y]??0;p=h?Math.min(p,k):k,g=h?Math.max(g,k):k,h=!0}i[d]=p,r[d]=g}return{min:i,max:r}}function D(n,e,a){return Math.max(e,Math.min(a,n))}function ne(n,e={}){let a=e.min??2,t=e.max??8,i=Math.round((Number.isFinite(n)?n:0)/44),r=Math.min(t,Math.max(a,i));return e.even&&r%2!==0&&(r=Math.max(a,r-1)),r}function U(n){let e=Math.max(0,Number.isFinite(n)?n:0);if(e>=1e3){let a=e/1e3;return`${a>=100?Math.round(a):Math.round(a*10)/10}k`}return`${Math.round(e)}`}var j=1e-6;function Z(n,e,a,t,i){let r=Math.max(j,i-t),s=Math.max(j,n.max-n.min),o=Math.min(r,Math.max(j,s*a)),l=Math.min(n.max,Math.max(n.min,e)),d=(l-n.min)/s,c=l-d*o,u=c+o;return c<t&&(c=t,u=t+o),u>i&&(u=i,c=i-o),{min:Math.max(t,c),max:Math.min(i,u)}}function ie(n,e,a,t){let i=Math.max(j,n.max-n.min),r=Math.max(a,t-i),s=Math.min(r,Math.max(a,n.min+e));return{min:s,max:s+i}}var Ma=`
  ...
  `;function K(){return new Worker(URL.createObjectURL(new Blob([Ma],{type:"text/javascript"})))}function He(n,e){let a=e.toLowerCase().split(".").pop();return a==="wav"||a==="wave"?{sampleRate:Ca(n)}:a==="flac"?{sampleRate:Ha(n)}:{}}function Be(n,e){let a=e.toLowerCase().split(".").pop();if(a==="wav"||a==="wave")return za(n);if(a==="flac")return Ba(n);if(a==="ogg"||a==="opus")return Ea(n);if(a==="m4a"||a==="mp4")return Fe(n);if(a==="aac")return Wa(n)??Fe(n);if(a==="mp3")return Va(n)}function Ca(n){if(n.byteLength<28||w(n,0,4)!=="RIFF"||w(n,8,12)!=="WAVE")return;let e=new DataView(n.buffer,n.byteOffset,n.byteLength),a=12;for(;a+8<=n.byteLength;){let t=w(n,a,a+4),i=e.getUint32(a+4,!0),r=a+8;if(t==="fmt "&&r+8<=n.byteLength){let s=e.getUint32(r+4,!0);return s>0?s:void 0}a=r+i+i%2}}function za(n){if(n.byteLength<12||w(n,0,4)!=="RIFF"||w(n,8,12)!=="WAVE")return;let e=new DataView(n.buffer,n.byteOffset,n.byteLength),a=[{offset:0,size:4,field:"ChunkID",value:w(n,0,4),note:"RIFF"},{offset:4,size:4,field:"ChunkSize",value:`${e.getUint32(4,!0)} B`,note:"\u6587\u4EF6\u5927\u5C0F - 8"},{offset:8,size:4,field:"Format",value:w(n,8,12),note:"WAVE"}],t=12,i,r,s,o=[];for(;t+8<=n.byteLength;){let l=w(n,t,t+4),d=l.trimEnd()||l,c=e.getUint32(t+4,!0),u=t+8,p=Math.min(u+c,n.byteLength);a.push({offset:t,size:4,field:`${d}.ChunkID`,value:l,note:"\u5B50\u5757 ID"}),a.push({offset:t+4,size:4,field:`${d}.ChunkSize`,value:`${c} B`,note:"\u5B50\u5757\u6570\u636E\u957F\u5EA6"}),l==="fmt "?(r=c,u+2<=p&&(s=e.getUint16(u,!0)),Ra(a,e,u,p)):l==="data"?(i=u,a.push({offset:u,size:c,field:"data.Payload",value:"",note:"\u97F3\u9891\u6570\u636E\u533A\u57DF"})):c>0&&(i===void 0&&o.push(d),a.push({offset:u,size:c,field:`${d}.Payload`,value:`${c} B`,note:"\u672A\u5C55\u5F00\u5B50\u5757"})),t=u+c+c%2}return{format:"WAV / RIFF",summary:Aa(i,r,s,o),rows:a}}function Aa(n,e,a,t){if(n===void 0)return{tone:"warning",kind:"wavHeader",missingData:!0,text:"\u672A\u627E\u5230 data chunk",detail:"\u65E0\u6CD5\u5224\u65AD WAV \u5934\u957F\u5EA6\u3002"};if(n===44&&e===16&&a===1)return{tone:"info",kind:"wavHeader",headerSize:n,standard:!0,text:`WAV \u5934\u957F\u5EA6 ${n} B`,detail:"\u6807\u51C6 44 \u5B57\u8282 PCM \u5934\u3002"};let r=Ta(e,a,t);return{tone:"warning",kind:"wavHeader",headerSize:n,standard:!1,reasons:r,text:`WAV \u5934\u957F\u5EA6 ${n} B`,detail:Fa(r).join("\uFF1B")}}function Ta(n,e,a){let t=[];return n!==void 0&&n!==16&&t.push({type:"fmtExtended",size:n}),e!==void 0&&e!==1&&t.push({type:"format",format:e,name:Le(e)}),a.length>0&&t.push({type:"extraChunks",chunks:a}),t}function Fa(n){return n.map(e=>{switch(e.type){case"fmtExtended":return`fmt \u5B50\u5757\u4E3A ${e.size} B\uFF0C\u5305\u542B\u6269\u5C55\u683C\u5F0F\u5B57\u6BB5`;case"format":return`\u7F16\u7801\u683C\u5F0F\u4E3A ${e.format} (${e.name})`;case"extraChunks":return`data \u524D\u6709\u989D\u5916\u5B50\u5757 ${e.chunks.join(", ")}`;case"dataOffset":return"data \u8D77\u59CB\u504F\u79FB\u4E0D\u662F 44 B"}})}function Ra(n,e,a,t){if(a+16>t){n.push({offset:a,size:Math.max(0,t-a),field:"fmt.Payload",value:"\u4E0D\u5B8C\u6574",note:"fmt \u5B50\u5757\u8FC7\u77ED"});return}let i=e.getUint16(a,!0),r=e.getUint16(a+2,!0),s=e.getUint32(a+4,!0),o=e.getUint32(a+8,!0),l=e.getUint16(a+12,!0),d=e.getUint16(a+14,!0);n.push({offset:a,size:2,field:"fmt.AudioFormat",value:`${i} (${Le(i)})`,note:"\u7F16\u7801\u683C\u5F0F"}),n.push({offset:a+2,size:2,field:"fmt.NumChannels",value:String(r),note:"\u901A\u9053\u6570"}),n.push({offset:a+4,size:4,field:"fmt.SampleRate",value:`${s} Hz`,note:"\u91C7\u6837\u7387"}),n.push({offset:a+8,size:4,field:"fmt.ByteRate",value:`${o} B/s`,note:"\u5B57\u8282\u7387"}),n.push({offset:a+12,size:2,field:"fmt.BlockAlign",value:`${l} B`,note:"\u6BCF\u5E27\u5B57\u8282\u6570"}),n.push({offset:a+14,size:2,field:"fmt.BitsPerSample",value:`${d} bit`,note:"\u4F4D\u6DF1"}),a+18<=t&&n.push({offset:a+16,size:2,field:"fmt.CbSize",value:`${e.getUint16(a+16,!0)} B`,note:"\u6269\u5C55\u53C2\u6570\u957F\u5EA6"}),a+24<=t&&i===65534&&(n.push({offset:a+18,size:2,field:"fmt.ValidBitsPerSample",value:`${e.getUint16(a+18,!0)} bit`,note:"\u6709\u6548\u4F4D\u6DF1"}),n.push({offset:a+20,size:4,field:"fmt.ChannelMask",value:`0x${e.getUint32(a+20,!0).toString(16)}`,note:"\u58F0\u9053\u5E03\u5C40\u63A9\u7801"}))}function Le(n){switch(n){case 1:return"PCM";case 3:return"IEEE Float";case 6:return"A-law";case 7:return"Mu-law";case 65534:return"Extensible";default:return"Unknown"}}function Ha(n){if(n.byteLength<42||w(n,0,4)!=="fLaC")return;let e=n[4]&127,a=n[5]<<16|n[6]<<8|n[7];if(e!==0||a<34||n.byteLength<42)return;let t=8,i=n[t+10]<<12|n[t+11]<<4|n[t+12]>>4;return i>0?i:void 0}function Ba(n){if(n.byteLength<4||w(n,0,4)!=="fLaC")return;let e=[{offset:0,size:4,field:"Marker",value:"fLaC",note:"FLAC \u6807\u8BC6"}],a=4;for(;a+4<=n.byteLength;){let t=n[a]??0,i=(t&128)!==0,r=t&127,s=oe(n,a+1),o=a+4,l=ja(r);if(e.push({offset:a,size:1,field:`${l}.Header`,value:`last=${i}, type=${r}`,note:"\u5143\u6570\u636E\u5757\u5934"}),e.push({offset:a+1,size:3,field:`${l}.Length`,value:`${s} B`,note:"\u5143\u6570\u636E\u5757\u957F\u5EA6"}),r===0&&o+34<=n.byteLength?La(e,n,o):s>0&&e.push({offset:o,size:s,field:`${l}.Payload`,value:`${s} B`,note:"\u5143\u6570\u636E\u5757\u5185\u5BB9"}),a=o+s,i)break}return{format:"FLAC",rows:e}}function La(n,e,a){let t=Re(e,a),i=Re(e,a+2),r=oe(e,a+4),s=oe(e,a+7),o=e[a+10]<<12|e[a+11]<<4|e[a+12]>>4,l=(e[a+12]>>1&7)+1,d=((e[a+12]&1)<<4|e[a+13]>>4)+1,c=(BigInt(e[a+13]&15)<<32n|BigInt(e[a+14])<<24n|BigInt(e[a+15])<<16n|BigInt(e[a+16])<<8n|BigInt(e[a+17])).toString();n.push({offset:a,size:2,field:"STREAMINFO.MinBlockSize",value:String(t),note:"\u6700\u5C0F\u5757\u5927\u5C0F"}),n.push({offset:a+2,size:2,field:"STREAMINFO.MaxBlockSize",value:String(i),note:"\u6700\u5927\u5757\u5927\u5C0F"}),n.push({offset:a+4,size:3,field:"STREAMINFO.MinFrameSize",value:`${r} B`,note:"\u6700\u5C0F\u5E27\u5927\u5C0F"}),n.push({offset:a+7,size:3,field:"STREAMINFO.MaxFrameSize",value:`${s} B`,note:"\u6700\u5927\u5E27\u5927\u5C0F"}),n.push({offset:a+10,size:3,bits:"80-99 (20 bit)",field:"STREAMINFO.SampleRate",value:`${o} Hz`,note:"\u91C7\u6837\u7387"}),n.push({offset:a+12,size:1,bits:"100-102 (3 bit)",field:"STREAMINFO.Channels",value:String(l),note:"\u901A\u9053\u6570"}),n.push({offset:a+12,size:2,bits:"103-107 (5 bit)",field:"STREAMINFO.BitsPerSample",value:`${d} bit`,note:"\u4F4D\u6DF1"}),n.push({offset:a+13,size:5,bits:"108-143 (36 bit)",field:"STREAMINFO.TotalSamples",value:c,note:"\u603B\u91C7\u6837\u6570"}),n.push({offset:a+18,size:16,field:"STREAMINFO.MD5",value:Ie(e,a+18,a+34),note:"\u539F\u59CB\u97F3\u9891 MD5"})}function Ea(n){if(n.byteLength<27||w(n,0,4)!=="OggS")return;let e=new DataView(n.buffer,n.byteOffset,n.byteLength),a=[],t=0,i=0;for(;t+27<=n.byteLength&&i<4&&w(n,t,t+4)==="OggS";){let r=n[t+26]??0;if(t+27+r>n.byteLength)break;let s=Oa(n,t+27,t+27+r),o=`Page${i}`;a.push({offset:t,size:4,field:`${o}.CapturePattern`,value:"OggS",note:"Ogg \u9875\u6807\u8BC6"}),a.push({offset:t+4,size:1,field:`${o}.Version`,value:String(n[t+4]??0),note:"\u6D41\u7ED3\u6784\u7248\u672C"}),a.push({offset:t+5,size:1,field:`${o}.HeaderType`,value:Ua(n[t+5]??0),note:"\u9875\u7C7B\u578B\u6807\u5FD7"}),a.push({offset:t+6,size:8,field:`${o}.GranulePosition`,value:e.getBigUint64(t+6,!0).toString(),note:"\u7EDD\u5BF9\u4F4D\u7F6E"}),a.push({offset:t+14,size:4,field:`${o}.BitstreamSerialNumber`,value:String(e.getUint32(t+14,!0)),note:"\u903B\u8F91\u6D41\u5E8F\u53F7"}),a.push({offset:t+18,size:4,field:`${o}.PageSequenceNumber`,value:String(e.getUint32(t+18,!0)),note:"\u9875\u5E8F\u53F7"}),a.push({offset:t+22,size:4,field:`${o}.Checksum`,value:`0x${e.getUint32(t+22,!0).toString(16)}`,note:"\u9875\u6821\u9A8C\u548C"}),a.push({offset:t+26,size:1,field:`${o}.PageSegments`,value:String(r),note:"segment \u6570"}),a.push({offset:t+27,size:r,field:`${o}.SegmentTable`,value:`${r} B`,note:"segment \u957F\u5EA6\u8868"}),a.push({offset:t+27+r,size:s,field:`${o}.Payload`,value:`${s} B`,note:"\u9875\u6570\u636E"}),i===0&&Ia(a,n,t+27+r,s),t+=27+r+s,i+=1}return{format:"OGG",rows:a}}function Ia(n,e,a,t){if(t>=19&&w(e,a,a+8)==="OpusHead"){n.push({offset:a,size:8,field:"OpusHead.Magic",value:"OpusHead",note:"Opus \u8BC6\u522B\u5934"}),n.push({offset:a+8,size:1,field:"OpusHead.Version",value:String(e[a+8]??0),note:"\u7248\u672C"}),n.push({offset:a+9,size:1,field:"OpusHead.ChannelCount",value:String(e[a+9]??0),note:"\u901A\u9053\u6570"}),n.push({offset:a+10,size:2,field:"OpusHead.PreSkip",value:String(De(e,a+10)),note:"\u9884\u8DF3\u8FC7\u91C7\u6837\u6570"}),n.push({offset:a+12,size:4,field:"OpusHead.InputSampleRate",value:`${re(e,a+12)} Hz`,note:"\u8F93\u5165\u91C7\u6837\u7387"}),n.push({offset:a+16,size:2,field:"OpusHead.OutputGain",value:String(Na(e,a+16)),note:"\u8F93\u51FA\u589E\u76CA"}),n.push({offset:a+18,size:1,field:"OpusHead.ChannelMappingFamily",value:String(e[a+18]??0),note:"\u58F0\u9053\u6620\u5C04\u65CF"});return}t>=30&&e[a]===1&&w(e,a+1,a+7)==="vorbis"&&(n.push({offset:a,size:1,field:"Vorbis.PacketType",value:"1",note:"\u8BC6\u522B\u5934"}),n.push({offset:a+1,size:6,field:"Vorbis.Magic",value:"vorbis",note:"Vorbis \u6807\u8BC6"}),n.push({offset:a+7,size:4,field:"Vorbis.Version",value:String(re(e,a+7)),note:"\u7248\u672C"}),n.push({offset:a+11,size:1,field:"Vorbis.Channels",value:String(e[a+11]??0),note:"\u901A\u9053\u6570"}),n.push({offset:a+12,size:4,field:"Vorbis.SampleRate",value:`${re(e,a+12)} Hz`,note:"\u91C7\u6837\u7387"}))}function Fe(n){if(n.byteLength<8)return;let e=[];return Ee(e,n,0,n.byteLength,0),e.length>0?{format:"M4A / MP4",rows:e}:void 0}function Ee(n,e,a,t,i){let r=Da(e,a,t);r.forEach((s,o)=>{if(n.length>=420)return;let l=o===r.length-1;n.push({offset:s.offset,size:s.boxSize,depth:i,treePrefix:l?"\u2514\u2500":"\u251C\u2500",kind:"box",field:s.type,value:"",note:"box \u7C7B\u578B"});let d=s.offset+s.headerSize,c=s.offset+s.boxSize;if(qa(n,e,s.type,d,c,i+1,l),Ka(s.type)){let u=s.type==="meta"?d+4:d;u<=c&&Ee(n,e,u,c,i+1)}})}function Da(n,e,a){let t=[],i=e;for(;i+8<=a&&t.length<420;){let r=H(n,i),s=w(n,i+4,i+8);if(!Za(s))break;let o=8,l=r;if(r===1&&i+16<=a?(l=Number(qe(n,i+8)),o=16):r===0&&(l=a-i),l<o||i+l>a)break;t.push({offset:i,type:s,boxSize:l,headerSize:o}),i+=l}return t}function qa(n,e,a,t,i,r,s){let o=s?"  \u251C\u2500":"\u2502 \u251C\u2500";if(a==="ftyp"&&t+8<=i){n.push({offset:t,size:4,depth:r,treePrefix:o,kind:"field",field:"MajorBrand",value:w(e,t,t+4),note:"\u4E3B\u54C1\u724C"}),n.push({offset:t+4,size:4,depth:r,treePrefix:o,kind:"field",field:"MinorVersion",value:String(H(e,t+4)),note:"\u6B21\u7248\u672C"}),t+8<i&&n.push({offset:t+8,size:i-t-8,depth:r,treePrefix:o,kind:"field",field:"CompatibleBrands",value:$a(e,t+8,i),note:"\u517C\u5BB9\u54C1\u724C"});return}if((a==="mvhd"||a==="mdhd")&&t+20<=i){let l=e[t]??0;n.push({offset:t,size:1,depth:r,treePrefix:o,kind:"field",field:"Version",value:String(l),note:"\u7248\u672C"}),n.push({offset:t+1,size:3,depth:r,treePrefix:o,kind:"field",field:"Flags",value:`0x${Ie(e,t+1,t+4)}`,note:"\u6807\u5FD7"}),l===1&&t+32<=i?(n.push({offset:t+20,size:4,depth:r,treePrefix:o,kind:"field",field:"Timescale",value:String(H(e,t+20)),note:"\u65F6\u95F4\u523B\u5EA6"}),n.push({offset:t+24,size:8,depth:r,treePrefix:o,kind:"field",field:"Duration",value:qe(e,t+24).toString(),note:"\u65F6\u957F\u5355\u4F4D\u6570"})):t+20<=i&&(n.push({offset:t+12,size:4,depth:r,treePrefix:o,kind:"field",field:"Timescale",value:String(H(e,t+12)),note:"\u65F6\u95F4\u523B\u5EA6"}),n.push({offset:t+16,size:4,depth:r,treePrefix:o,kind:"field",field:"Duration",value:String(H(e,t+16)),note:"\u65F6\u957F\u5355\u4F4D\u6570"}));return}if(a==="hdlr"&&t+12<=i){n.push({offset:t,size:1,depth:r,treePrefix:o,kind:"field",field:"Version",value:String(e[t]??0),note:"\u7248\u672C"}),n.push({offset:t+8,size:4,depth:r,treePrefix:o,kind:"field",field:"HandlerType",value:w(e,t+8,t+12),note:"\u5904\u7406\u5668\u7C7B\u578B"});return}a==="stsd"&&t+16<=i&&(n.push({offset:t,size:1,depth:r,treePrefix:o,kind:"field",field:"Version",value:String(e[t]??0),note:"\u7248\u672C"}),n.push({offset:t+4,size:4,depth:r,treePrefix:o,kind:"field",field:"EntryCount",value:String(H(e,t+4)),note:"\u6837\u672C\u63CF\u8FF0\u6570\u91CF"}),n.push({offset:t+12,size:4,depth:r,treePrefix:o,kind:"field",field:"SampleEntryType",value:w(e,t+12,t+16),note:"\u6837\u672C\u7C7B\u578B"}))}function Wa(n){if(n.byteLength<7||n[0]!==255||((n[1]??0)&240)!==240)return;let e=n[1]&1,a=n[2]>>6&3,t=n[2]>>2&15,i=(n[2]&1)<<2|n[3]>>6&3,r=(n[3]&3)<<11|n[4]<<3|n[5]>>5&7,s=(n[5]&31)<<6|n[6]>>2&63,o=n[6]&3;return{format:"AAC / ADTS",rows:[{offset:0,size:2,bits:"0-11 (12 bit)",field:"ADTS.Syncword",value:"0xfff",note:"\u540C\u6B65\u5B57"},{offset:1,size:1,bits:"12 (1 bit)",field:"ADTS.MpegVersion",value:n[1]>>3&1?"MPEG-2":"MPEG-4",note:"MPEG \u7248\u672C"},{offset:1,size:1,bits:"13-14 (2 bit)",field:"ADTS.Layer",value:String(n[1]>>1&3),note:"\u5C42"},{offset:1,size:1,bits:"15 (1 bit)",field:"ADTS.ProtectionAbsent",value:String(e),note:"CRC \u662F\u5426\u7701\u7565"},{offset:2,size:1,bits:"16-17 (2 bit)",field:"ADTS.Profile",value:`${a} (${_a(a)})`,note:"AAC profile"},{offset:2,size:1,bits:"18-21 (4 bit)",field:"ADTS.SamplingFrequencyIndex",value:`${t} (${Xa(t)})`,note:"\u91C7\u6837\u7387\u7D22\u5F15"},{offset:2,size:2,bits:"23-25 (3 bit)",field:"ADTS.ChannelConfiguration",value:String(i),note:"\u58F0\u9053\u914D\u7F6E"},{offset:3,size:3,bits:"30-42 (13 bit)",field:"ADTS.FrameLength",value:`${r} B`,note:"ADTS \u5E27\u957F\u5EA6"},{offset:5,size:2,bits:"43-53 (11 bit)",field:"ADTS.BufferFullness",value:String(s),note:"\u7F13\u51B2 fullness"},{offset:6,size:1,bits:"54-55 (2 bit)",field:"ADTS.RawDataBlocks",value:String(o),note:"\u539F\u59CB\u6570\u636E\u5757\u6570\u91CF\u5B57\u6BB5"}]}}function Va(n){let e=[],a=0;if(n.byteLength>=10&&w(n,0,3)==="ID3"){let t=Ga(n,6);e.push({offset:0,size:3,field:"ID3.Identifier",value:"ID3",note:"ID3v2 \u6807\u8BC6"}),e.push({offset:3,size:2,field:"ID3.Version",value:`${n[3]??0}.${n[4]??0}`,note:"ID3 \u7248\u672C"}),e.push({offset:5,size:1,field:"ID3.Flags",value:`0x${(n[5]??0).toString(16)}`,note:"\u6807\u5FD7"}),e.push({offset:6,size:4,field:"ID3.Size",value:`${t} B`,note:"\u6807\u7B7E\u957F\u5EA6"}),a=10+t}for(;a+4<=n.byteLength&&!(n[a]===255&&((n[a+1]??0)&224)===224);)a+=1;return a+4>n.byteLength?e.length>0?{format:"MP3",rows:e}:void 0:(e.push({offset:a,size:2,bits:"frame 0-10 (11 bit)",field:"MPEG.Sync",value:"0x7ff",note:"\u5E27\u540C\u6B65"}),e.push({offset:a+1,size:1,bits:"frame 11-12 (2 bit)",field:"MPEG.Version",value:Ya(n[a+1]>>3&3),note:"MPEG \u97F3\u9891\u7248\u672C"}),e.push({offset:a+1,size:1,bits:"frame 13-14 (2 bit)",field:"MPEG.Layer",value:Ja(n[a+1]>>1&3),note:"Layer"}),e.push({offset:a+1,size:1,bits:"frame 15 (1 bit)",field:"MPEG.ProtectionBit",value:String(n[a+1]&1),note:"CRC \u6807\u5FD7"}),e.push({offset:a+2,size:1,bits:"frame 16-19 (4 bit)",field:"MPEG.BitrateIndex",value:String(n[a+2]>>4&15),note:"\u7801\u7387\u7D22\u5F15"}),e.push({offset:a+2,size:1,bits:"frame 20-21 (2 bit)",field:"MPEG.SamplingRateIndex",value:String(n[a+2]>>2&3),note:"\u91C7\u6837\u7387\u7D22\u5F15"}),e.push({offset:a+3,size:1,bits:"frame 24-25 (2 bit)",field:"MPEG.ChannelMode",value:Qa(n[a+3]>>6&3),note:"\u58F0\u9053\u6A21\u5F0F"}),{format:"MP3",rows:e})}function w(n,e,a){let t="";for(let i=e;i<a;i+=1)t+=String.fromCharCode(n[i]??0);return t}function Ie(n,e,a){let t="";for(let i=e;i<a;i+=1)t+=(n[i]??0).toString(16).padStart(2,"0");return t}function Re(n,e){return(n[e]??0)<<8|(n[e+1]??0)}function De(n,e){return(n[e]??0)|(n[e+1]??0)<<8}function Na(n,e){let a=De(n,e);return a>=32768?a-65536:a}function oe(n,e){return(n[e]??0)<<16|(n[e+1]??0)<<8|(n[e+2]??0)}function H(n,e){return(n[e]??0)*16777216+((n[e+1]??0)<<16|(n[e+2]??0)<<8|(n[e+3]??0))}function re(n,e){return(n[e]??0)|(n[e+1]??0)<<8|(n[e+2]??0)<<16|(n[e+3]??0)*16777216}function qe(n,e){return BigInt(n[e]??0)<<56n|BigInt(n[e+1]??0)<<48n|BigInt(n[e+2]??0)<<40n|BigInt(n[e+3]??0)<<32n|BigInt(n[e+4]??0)<<24n|BigInt(n[e+5]??0)<<16n|BigInt(n[e+6]??0)<<8n|BigInt(n[e+7]??0)}function Ga(n,e){return(n[e]&127)<<21|(n[e+1]&127)<<14|(n[e+2]&127)<<7|n[e+3]&127}function Oa(n,e,a){let t=0;for(let i=e;i<a;i+=1)t+=n[i]??0;return t}function ja(n){return["STREAMINFO","PADDING","APPLICATION","SEEKTABLE","VORBIS_COMMENT","CUESHEET","PICTURE"][n]??`BLOCK_${n}`}function Ua(n){let e=[];return n&1&&e.push("continued"),n&2&&e.push("first"),n&4&&e.push("last"),e.length?`${n} (${e.join(", ")})`:String(n)}function Za(n){return/^[A-Za-z0-9 _-]{4}$/.test(n)}function Ka(n){return["moov","trak","mdia","minf","stbl","edts","udta","meta","ilst"].includes(n)}function $a(n,e,a){let t=[];for(let i=e;i+4<=a;i+=4)t.push(w(n,i,i+4));return t.join(", ")}function _a(n){return["Main","LC","SSR","Reserved"][n]??"Unknown"}function Xa(n){return["96000 Hz","88200 Hz","64000 Hz","48000 Hz","44100 Hz","32000 Hz","24000 Hz","22050 Hz","16000 Hz","12000 Hz","11025 Hz","8000 Hz","7350 Hz"][n]??"reserved"}function Ya(n){return["MPEG 2.5","reserved","MPEG 2","MPEG 1"][n]??"unknown"}function Ja(n){return["reserved","Layer III","Layer II","Layer I"][n]??"unknown"}function Qa(n){return["Stereo","Joint stereo","Dual channel","Single channel"][n]??"unknown"}function m(n,e){let a=document.querySelector(n);if(!(a instanceof e))throw new Error(`Missing element: ${n}`);return a}function B(n){let e=n.getBoundingClientRect(),a=window.devicePixelRatio||1,t=Math.max(1,Math.floor(e.width*a)),i=Math.max(1,Math.floor(e.height*a));(n.width!==t||n.height!==i)&&(n.width=t,n.height=i);let r=n.getContext("2d",{alpha:!1});if(!r)throw new Error("Canvas 2D context unavailable");return r}function se(n){let e=Math.floor(n/60),a=Math.floor(n%60),t=Math.floor((n-Math.floor(n))*1e3);return`${e}:${String(a).padStart(2,"0")}.${String(t).padStart(3,"0")}`}function le(n){if(n<1024)return`${n} B`;let e=["KB","MB","GB"],a=n/1024,t=0;for(;a>=1024&&t<e.length-1;)a/=1024,t+=1;return`${a.toFixed(a>=10?1:2)} ${e[t]}`}function f(n,e,a){return Math.max(e,Math.min(a,n))}function We(n){let e=n.toLowerCase().split(".").pop();return e==="mp3"?"audio/mpeg":e==="ogg"?"audio/ogg":e==="opus"?"audio/ogg; codecs=opus":e==="flac"?"audio/flac":e==="m4a"?"audio/mp4":e==="aac"?"audio/aac":"audio/wav"}var Ve={waitingAudioFile:"Warte auf Audiodatei",initializing:"Initialisierung",spectrogramSettings:"Spectrogram-Einstellungen",playPause:"Wiedergabe / Pause",playbackPosition:"Wiedergabeposition",closeSettings:"Einstellungen schliessen",spectrogramDisplay:"Spectrogram-Anzeige",algorithm:"Algorithmus",algorithmFrequency:"Frequenz",algorithmReassignment:"Reassignment",algorithmPitchEac:"Pitch (EAC)",windowSize:"Fenstergroesse",windowType:"Fenstertyp",windowRectangular:"Rechteck",windowBartlett:"Bartlett",windowHamming:"Hamming",windowHann:"Hann",windowBlackman:"Blackman",windowBlackmanHarris:"Blackman-Harris",windowWelch:"Welch",windowGaussian25:"Gauss (\u03B1=2.5)",windowGaussian35:"Gauss (\u03B1=3.5)",windowGaussian45:"Gauss (\u03B1=4.5)",zeroPaddingFactor:"Null-Padding-Faktor",frequencyScale:"Frequenzskala",frequencyRange:"Frequenzbereich (nur Anzeige)",minFrequencyHz:"Min. Frequenz (Hz)",maxFrequencyHz:"Max. Frequenz (Hz)",maxFrequencyNyquist:"Max folgt Nyquist",spectrogramAppearance:"Spectrogram-Darstellung",palette:"Palette",paletteRose:"Rose",paletteClassic:"Klassisch",paletteGrayscale:"Graustufen",paletteInverseGrayscale:"Inverse Graustufen",minDb:"Min. dB (Helligkeit)",maxDb:"Max. dB (Helligkeit)",autoBrightness:"Auto-Helligkeit",amplitudeRange:"Amplitudenbereich (Wellenform)",minAmplitude:"Min. Amplitude",maxAmplitude:"Max. Amplitude",amplitudeAuto:"Auto (pro Kanal)",channel:"Kanal",timeZoom:"Zeitzoom",timePosition:"Zeitposition",mouseWheel:"Mausrad",help:"Hilfe",downloadAudio:"Audio herunterladen",downloadSelection:"Auswahl herunterladen",downloadSelectionWav:"Auswahl als WAV herunterladen",clearSelection:"Auswahl loeschen",noSelectionToDownload:"Keine Audioauswahl zum Herunterladen",headerInfo:"Header-Info",headerInfoTitle:"Header-Info",headerInfoAudioUnread:"Audiodaten wurden noch nicht gelesen.",headerInfoUnsupported:"Header-Parsing wird f\xFCr dieses Format noch nicht unterst\xFCtzt.",headerInfoOffset:"Offset",headerInfoByteOffset:"Byte-Offset",headerInfoSize:"L\xE4nge",headerInfoBits:"Bits",headerInfoField:"Feld",headerInfoValue:"Wert",headerInfoDescription:"Beschreibung",headerInfoWavMissingData:"data-Chunk nicht gefunden",headerInfoWavCannotDetermine:"WAV-Headerl\xE4nge kann nicht bestimmt werden.",headerInfoWavHeaderLength:"WAV-Headerl\xE4nge {size} B",headerInfoWavStandardPcm:"Standardm\xE4\xDFiger 44-Byte-PCM-Header.",headerInfoWavNonStandardPrefix:"Nicht standardm\xE4\xDFiger 44-Byte-PCM-Header",headerInfoWavFmtExtended:"fmt-Chunk ist {size} B gro\xDF und enth\xE4lt erweiterte Formatfelder",headerInfoWavFormat:"Audioformat ist {format} ({name})",headerInfoWavExtraChunks:"zus\xE4tzliche Chunks vor data: {chunks}",headerInfoWavDataOffsetNon44:"data beginnt nicht bei Offset 44 B",headerInfoReasonSeparator:"; ",arkOffsetLabel:"ARK-Offset",settings:"Einstellungen",pcmReadAs:"Als PCM lesen",pcmParams:"PCM-Dateiparameter",editPcmParams:"Parameter bearbeiten",wavPcmRead:"WAV als PCM lesen",currentFileOnly:"Nur aktuelle Datei",sampleRate:"Abtastrate",channels:"Kan\xE4le",startOffsetBytes:"Offset (B)",bitDepth:"Kodierung",sampleFormat:"Format",endianness:"Byte order",read:"Lesen",saveDefault:"Standard speichern",cancel:"Abbrechen",defaultView:"Standardansicht",view:"Ansicht",viewBoth:"Mehrfachansicht",mute:"Stumm",solo:"Solo",timeLabel:"Zeit",helpTimeZoom:"Zeitzoom",helpTimePan:"Zeit verschieben",helpAmplitudeZoom:"Amplitudenzoom",helpRightClick:"Rechtsklick",helpPinch:"Pinch",helpHorizontalSwipe:"Horizontal wischen",helpDoubleClick:"Doppelklick",helpPlaybackGroup:"Wiedergabe & Auswahl",helpViewGroup:"Ansichtsnavigation",helpMouseGroup:"Maus & Trackpad",helpGainGroup:"Gain & Panorama",helpPlayPause:"Wiedergabe / Pause",helpClearSelection:"Men\xFC schlie\xDFen, Auswahl l\xF6schen oder Wiedergabecursor zur\xFCcksetzen",helpResetTimeZoom:"Zeitzoom zur\xFCcksetzen",helpTrackpadZoom:"Mit Trackpad-Pinch die Zeit zoomen",helpTrackpadPan:"Horizontaler Trackpad-Swipe verschiebt die Zeit",helpGainReset:"Gain- oder Panorama-Regler doppelklicken, um ihn zur\xFCckzusetzen",helpSelectionPlayback:"Wellenform oder Spektrogramm ziehen, um einen Bereich auszuw\xE4hlen. Bei aktiver Auswahl wird nur dieser Bereich abgespielt.",refreshSpectrogram:"Spectrogram aktualisieren",resetView:"Ansicht zuruecksetzen",selectionAnalysis:"Auswahlanalyse",selectionStart:"Start",selectionEnd:"Ende",selectionDuration:"Dauer",rmsLevel:"RMS-Pegel",peakLevel:"Peak-Pegel",dominant:"Dominant",crestFactor:"Crest",clippingRatio:"Clipping",noiseFloor:"Noise Floor",spectralCentroid:"Zentroid",zeroCrossingRate:"ZCR",basicMetrics:"Basiswerte",selectionAnalysisHelp:`Auswahlanalyse:
...
\u8A08\u7B97\uFF1A
\u5C07\u9078\u5340\u5207\u6210 50% overlap \u7684 FFT frame\uFF0C\u7D2F\u7A4D\u5404 bin \u529F\u7387\u5F8C\u5206\u914D\u5230\u983B\u5E36\u4E26\u986F\u793A\u767E\u5206\u6BD4\u3002`,selectionAnalysisCalculating:"\u8A08\u7B97\u4E2D...",bands:"\u983B\u5E36",waveform:"\u6CE2\u5F62",spectrogram:"\u983B\u8B5C\u5716",adjustWaveformHeight:"\u8ABF\u6574\u6CE2\u5F62\u9AD8\u5EA6",adjustSpectrogramHeight:"\u8ABF\u6574\u983B\u8B5C\u5716\u9AD8\u5EA6",ready:"\u5C31\u7DD2",workspaceNotTrusted:"\u5DE5\u4F5C\u5340\u4E0D\u53D7\u4FE1\u4EFB",fileTooLarge:"\u6A94\u6848\u8D85\u904E\u9650\u5236",readingAudio:"\u8B80\u53D6\u97F3\u8A0A\u4E2D",readingAudioProgress:"\u8B80\u53D6\u97F3\u8A0A\u4E2D",decodingAudio:"\u89E3\u78BC\u97F3\u8A0A\u4E2D",transcodingAudio:"\u6B63\u5728\u4F7F\u7528 FFmpeg \u8F49\u78BC\u97F3\u8A0A",encodedPlaybackOnly:"\u97F3\u8A0A\u89E3\u78BC\u5931\u6557\u3002",emptyWavNoAudio:"WAV \u6A94\u6848\u4E0D\u5305\u542B\u97F3\u8A0A\u8CC7\u6599\u3002",waitingPcmParams:"\u7B49\u5F85 PCM \u53C3\u6578",pcmUsedDefaultParams:"\u5DF2\u4F7F\u7528\u9810\u8A2D PCM \u53C3\u6578\u8F09\u5165\u3002",pcmFillParams:"\u8ACB\u586B\u5BEB PCM \u53C3\u6578\uFF0C\u7136\u5F8C\u9EDE\u64CA\u8B80\u53D6\u3002",wavPcmFillParams:"\u8ACB\u586B\u5BEB\u53C3\u6578\uFF0C\u7136\u5F8C\u9EDE\u64CA\u8B80\u53D6\uFF0C\u5C07\u76EE\u524D WAV \u6309 PCM \u89E3\u6790\u3002",currentPcmFormat:"\u76EE\u524D",savedDefaultPcmFormat:"\u5DF2\u5132\u5B58\u9810\u8A2D",audioLoaded:"\u97F3\u8A0A\u5DF2\u8F09\u5165",audioNotReady:"\u97F3\u8A0A\u5C1A\u672A\u5C31\u7DD2",audioCannotPlay:"\u6B64\u97F3\u8A0A\u7121\u6CD5\u5728 Webview \u64AD\u653E",playbackFailed:"\u64AD\u653E\u5931\u6557",analyzingSpectrogram:"\u5206\u6790\u983B\u8B5C\u5716\u4E2D",frequencyBand0To250:"0-250",frequencyBand250To500:"250-500",frequencyBand500To1k:"0.5-1k",frequencyBand1To2k:"1-2k",frequencyBand2To4k:"2-4k",frequencyBand4To8k:"4-8k",frequencyBand8kPlus:"8k+",pad:"pad",hop:"hop",initializationFailed:"AudioLens \u521D\u59CB\u5316\u5931\u6557",trackGain:"\u589E\u76CA",trackPan:"\u8072\u9053\u5E73\u8861",panLeft:"\u5DE6",panRight:"\u53F3",panCenter:"\u4E2D",doubleClickReset:"\u96D9\u64CA\u91CD\u8A2D",freqScaleMenuTitle:"\u8A72\u901A\u9053\u983B\u7387\u523B\u5EA6",restoreChannelDefault:"\u6062\u5FA9\u8A72\u901A\u9053\u9810\u8A2D",helpAxisGroup:"\u7E31\u5411\u5EA7\u6A19\u8EF8",helpAxisZoom:"\u5EA7\u6A19\u8EF8\u4E0A Ctrl+\u6EFE\u8F2A / \u634F\u5408\uFF1A\u7E2E\u653E\u8A72\u8EF8\uFF08\u6BCF\u901A\u9053\uFF09",helpAxisPan:"\u5EA7\u6A19\u8EF8\u4E0A Shift+\u6EFE\u8F2A / \u6A6B\u5411\u6ED1\u52D5\uFF1A\u5E73\u79FB\u8A72\u8EF8\uFF08\u6BCF\u901A\u9053\uFF09",helpAxisAlt:"\u6CE2\u5F62\u5716\u4E0A Alt+\u6EFE\u8F2A\uFF1A\u7E2E\u653E\u8A72\u901A\u9053\u632F\u5E45",helpAxisScaleMenu:"\u983B\u7387\u8EF8\u53F3\u9375\uFF1A\u8A2D\u5B9A\u8A72\u901A\u9053\u523B\u5EA6\u985E\u578B",helpAxisReset:"\u5EA7\u6A19\u8EF8\u96D9\u64CA\uFF1A\u6062\u5FA9\u8A72\u901A\u9053\u9810\u8A2D"};var et={"zh-CN":ea,"zh-TW":aa,en:de,ja:Ue,ko:Ze,fr:Ge,de:Ve,ru:Ye,es:Ne,it:je,pt:Xe,id:Oe,no:$e,nl:Ke,pl:_e,tr:Je,vi:Qe};function ce(n){return{...de,...et[n]??{}}}function at(n){let e=(n||"en").toLowerCase();return e==="zh-tw"||e==="zh-hk"||e==="zh-hant"||e.startsWith("zh-hant")?"zh-TW":e==="zh-cn"||e==="zh-sg"||e==="zh-hans"||e.startsWith("zh")?"zh-CN":e.startsWith("ja")?"ja":e.startsWith("ko")?"ko":e.startsWith("fr")?"fr":e.startsWith("de")?"de":e.startsWith("ru")?"ru":e.startsWith("es")?"es":e.startsWith("it")?"it":e.startsWith("pt")?"pt":e.startsWith("id")?"id":e.startsWith("no")||e.startsWith("nb")||e.startsWith("nn")?"no":e.startsWith("nl")?"nl":e.startsWith("pl")?"pl":e.startsWith("tr")?"tr":e.startsWith("vi")?"vi":"en"}function ta(n,e){return n&&n!=="auto"?n:at(e)}function W(n){switch(n){case"signed-8":return{bitDepth:8,sampleFormat:"signed-int",endianness:"none"};case"signed-16":return{bitDepth:16,sampleFormat:"signed-int",endianness:"little"};case"signed-24":return{bitDepth:24,sampleFormat:"signed-int",endianness:"little"};case"signed-32":return{bitDepth:32,sampleFormat:"signed-int",endianness:"little"};case"unsigned-8":return{bitDepth:8,sampleFormat:"unsigned-int",endianness:"none"};case"float-64":return{bitDepth:64,sampleFormat:"float",endianness:"little"};case"float-32":default:return{bitDepth:32,sampleFormat:"float",endianness:"little"}}}function V(n){return n.sampleFormat==="float"?n.bitDepth===64?"float-64":"float-32":n.sampleFormat==="unsigned-int"?"unsigned-8":n.bitDepth===8?"signed-8":n.bitDepth===24?"signed-24":n.bitDepth===32?"signed-32":"signed-16"}function ue(n,e){let a=ia(e),t=tt(n,a),i=he(a),r=na(a);if(i<=0||r<=0||t.byteLength%r!==0)throw new Error("PCM parameters do not match the file size.");let s=t.byteLength/r,o=Array.from({length:e.channels},()=>new Float32Array(s));for(let l=0;l<s;l+=1){let d=l*r;for(let c=0;c<e.channels;c+=1){let u=d+c*i;o[c][l]=nt(t,u,a)}}return{sampleRate:e.sampleRate,channels:o}}function me(n,e){let a=e.channels[0]?.length??0,t=n.createBuffer(e.channels.length,a,e.sampleRate);return e.channels.forEach((i,r)=>t.getChannelData(r).set(i)),t}function pe(n,e){let a=ia(e),t=e.startOffsetBytes??0;if(!Number.isFinite(e.sampleRate)||e.sampleRate<=0)return"PCM sample rate must be greater than 0.";if(!Number.isInteger(e.channels)||e.channels<=0)return"PCM channel count must be a positive integer.";if(![8,16,24,32,64].includes(a.bitDepth))return"PCM encoding must be Signed 8/16/24/32-bit PCM, Unsigned 8-bit PCM, 32-bit float, or 64-bit float.";if(a.sampleFormat==="float"&&a.bitDepth!==32&&a.bitDepth!==64)return"Float PCM supports 32-bit or 64-bit only.";if(a.sampleFormat==="unsigned-int"&&a.bitDepth!==8)return"Unsigned PCM currently supports 8-bit only.";if(a.bitDepth>8&&a.endianness==="none")return"Byte order is required for multi-byte PCM encodings.";if(!Number.isInteger(t)||t<0)return"PCM start offset must be a non-negative integer.";if(t>=n.byteLength)return`PCM start offset ${t} bytes exceeds the file size.`;let i=n.byteLength-t,r=na(a);if(r<=0||i%r!==0)return`Data size after offset (${i} bytes) is not aligned to the current PCM parameters.`}function tt(n,e){return n.subarray(e.startOffsetBytes??0)}function nt(n,e,a){let t=new DataView(n.buffer,n.byteOffset+e,he(a));if(a.sampleFormat==="float"){let i=a.endianness==="little";return rt(a.bitDepth===64?t.getFloat64(0,i):t.getFloat32(0,i),-1,1)}if(a.bitDepth===8)return a.sampleFormat==="unsigned-int"?(t.getUint8(0)-128)/128:t.getInt8(0)/128;if(a.bitDepth===16)return t.getInt16(0,a.endianness==="little")/32768;if(a.bitDepth===24){let r=a.endianness==="little"?t.getUint8(0)|t.getUint8(1)<<8|t.getUint8(2)<<16:t.getUint8(2)|t.getUint8(1)<<8|t.getUint8(0)<<16;return it(r)/8388608}return t.getInt32(0,a.endianness==="little")/2147483648}function it(n){return n&8388608?n|-16777216:n}function he(n){return n.bitDepth/8}function na(n){return he(n)*n.channels}function rt(n,e,a){return Math.max(e,Math.min(a,n))}function ia(n){let e=V(n),a=W(e),t=a.bitDepth===8?"none":n.endianness==="none"?a.endianness:n.endianness;return{...n,...a,endianness:t}}function ra(n){return n.innerHTML=`
    <main class="shell">
      <header class="topbar">
        <div class="identity">
  ...
  `,document.head.appendChild(n)}var Me=document.querySelector("#app");if(!Me)throw new Error("AudioLens root element missing");Sa();var xe=acquireVsCodeApi();try{let n=new Q(xe,ra(Me));window.addEventListener("message",e=>{n.handleMessage(e.data)}),xe.postMessage({type:"ready"})}catch(n){let e=n instanceof Error?n.message:String(n);Me.textContent=`AudioLens initialization failed: ${e}`,xe.postMessage({type:"showError",message:`AudioLens initialization failed: ${e}`})}})();
