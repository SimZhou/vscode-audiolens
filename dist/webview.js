"use strict";(()=>{function se(n,e){return n===0&&e>0||n===4294967295||n>e?e:n}function He(n){let e=Math.max(0,n.duration),t=Math.max(1,n.sampleRate),a=Math.max(1,n.timeZoom),i=T(n.timeOffset,0,1),s=e/a,r=Math.max(0,e-s)*i,l=Math.min(e,r+s);return{startSample:Math.floor(r*t),endSample:Math.floor(l*t),startTime:r,endTime:l}}function H(n,e){let t=T(Number.isFinite(n)?n:-96,-160,-1),a=T(Number.isFinite(e)?e:0,-80,24);return{minDb:t,maxDb:Math.max(a,t+1)}}function Be(n){return[n.channel,n.startSample,n.endSample,n.fftSize,n.windowFunction,n.zeroPaddingFactor??1,n.outputBins??0,n.targetFrames??0,n.hopSize??0,n.minDb,n.maxDb,n.spectrogramMinHz??0,n.spectrogramMaxHz??0,n.frequencyScale??"linear",n.palette??"classic"].join(":")}function Ee(n,e,t,a){let i=new Float32Array(a),s=new Float32Array(a);if(a<=0||n.length===0)return{min:i,max:s};let o=T(Math.floor(e),0,n.length),r=T(Math.ceil(t),o,n.length),l=Math.max(1,r-o);for(let d=0;d<a;d+=1){let c=Math.min(r-1,o+Math.floor(d*l/a)),u=Math.min(r,Math.max(c+1,o+Math.ceil((d+1)*l/a))),p=0,f=0,g=!1;for(let b=c;b<u;b+=1){let y=n[b]??0;p=g?Math.min(p,y):y,f=g?Math.max(f,y):y,g=!0}i[d]=p,s[d]=f}return{min:i,max:s}}function Ie(n){let e=Math.max(0,Math.floor(n.totalSamples)),t=T(Math.floor(n.visibleStartSample),0,e),a=T(Math.floor(n.visibleEndSample),t,e),i=Math.max(1,a-t),s=1;for(;s<i;)s*=2;let o=Math.max(1,Math.floor(s/4)),r=Math.floor(t/o)*o-o,l=Math.max(0,r),d=Math.max(l,Math.min(e,r+s+3*o)),c=Math.max(1,d-l),u=Math.max(1,Number.isFinite(n.devicePixelRatio)?n.devicePixelRatio:1),p=Math.max(1,n.plotWidthPixels/u),f=Math.max(360,Math.min(1800,Math.floor(p))),g=Math.ceil(f*c/i),b=Math.max(192,Math.min(900,Math.floor(n.plotHeightPixels))),y=Math.max(1,Math.floor(n.paddedFftSize/2)),v=Math.max(1,Math.floor(n.magnitudeByteBudget/(y*4*2))),k=Math.max(1,Math.floor(n.rasterByteBudget/(b*4*2))),S=Math.max(1,Math.min(g,v,k,n.maxTargetFrames??4096)),P=Math.max(1,c/S),M=1;for(;M*2<=P;)M*=2;return{startSample:l,endSample:d,hopSize:M,outputBins:b,targetFrames:S}}function Le(n,e,t,a){let i=Math.max(1,Math.floor(t/(Math.max(1,e)*4)));return Math.max(1,Math.min(a,i,Math.max(1,Math.floor(n)*2)))}function T(n,e,t){return Math.max(e,Math.min(t,n))}function re(n,e={}){let t=e.min??2,a=e.max??8,i=Math.round((Number.isFinite(n)?n:0)/44),s=Math.min(a,Math.max(t,i));return e.even&&s%2!==0&&(s=Math.max(t,s-1)),s}function Z(n){let e=Math.max(0,Number.isFinite(n)?n:0);if(e>=1e3){let t=e/1e3;return`${t>=100?Math.round(t):Math.round(t*10)/10}k`}return`${Math.round(e)}`}var _=1e-6;function K(n,e,t,a,i){let s=Math.max(_,i-a),o=Math.max(_,n.max-n.min),r=Math.min(s,Math.max(_,o*t)),l=Math.min(n.max,Math.max(n.min,e)),d=(l-n.min)/o,c=l-d*r,u=c+r;return c<a&&(c=a,u=a+r),u>i&&(u=i,c=i-r),{min:Math.max(a,c),max:Math.min(i,u)}}function oe(n,e,t,a){let i=Math.max(_,n.max-n.min),s=Math.max(t,a-i),o=Math.min(s,Math.max(t,n.min+e));return{min:o,max:o+i}}var Rt=`
...
\u5C07\u9078\u5340\u5207\u6210 50% overlap \u7684 FFT frame\uFF0C\u7D2F\u7A4D\u5404 bin \u529F\u7387\u5F8C\u5206\u914D\u5230\u983B\u5E36\u4E26\u986F\u793A\u767E\u5206\u6BD4\u3002`,selectionAnalysisCalculating:"\u8A08\u7B97\u4E2D...",bands:"\u983B\u5E36",waveform:"\u6CE2\u5F62",spectrogram:"\u983B\u8B5C\u5716",adjustWaveformHeight:"\u8ABF\u6574\u6CE2\u5F62\u9AD8\u5EA6",adjustSpectrogramHeight:"\u8ABF\u6574\u983B\u8B5C\u5716\u9AD8\u5EA6",ready:"\u5C31\u7DD2",workspaceNotTrusted:"\u5DE5\u4F5C\u5340\u4E0D\u53D7\u4FE1\u4EFB",fileTooLarge:"\u6A94\u6848\u8D85\u904E\u9650\u5236",readingAudio:"\u8B80\u53D6\u97F3\u8A0A\u4E2D",readingAudioProgress:"\u8B80\u53D6\u97F3\u8A0A\u4E2D",decodingAudio:"\u89E3\u78BC\u97F3\u8A0A\u4E2D",transcodingAudio:"\u6B63\u5728\u4F7F\u7528 FFmpeg \u8F49\u78BC\u97F3\u8A0A",encodedPlaybackOnly:"\u97F3\u8A0A\u89E3\u78BC\u5931\u6557\u3002",emptyWavNoAudio:"WAV \u6A94\u6848\u4E0D\u5305\u542B\u97F3\u8A0A\u8CC7\u6599\u3002",waitingPcmParams:"\u7B49\u5F85 PCM \u53C3\u6578",pcmUsedDefaultParams:"\u5DF2\u4F7F\u7528\u9810\u8A2D PCM \u53C3\u6578\u8F09\u5165\u3002",pcmFillParams:"\u8ACB\u586B\u5BEB PCM \u53C3\u6578\uFF0C\u7136\u5F8C\u9EDE\u64CA\u8B80\u53D6\u3002",wavPcmFillParams:"\u8ACB\u586B\u5BEB\u53C3\u6578\uFF0C\u7136\u5F8C\u9EDE\u64CA\u8B80\u53D6\uFF0C\u5C07\u76EE\u524D WAV \u6309 PCM \u89E3\u6790\u3002",currentPcmFormat:"\u76EE\u524D",savedDefaultPcmFormat:"\u5DF2\u5132\u5B58\u9810\u8A2D",audioLoaded:"\u97F3\u8A0A\u5DF2\u8F09\u5165",audioNotReady:"\u97F3\u8A0A\u5C1A\u672A\u5C31\u7DD2",audioCannotPlay:"\u6B64\u97F3\u8A0A\u7121\u6CD5\u5728 Webview \u64AD\u653E",playbackFailed:"\u64AD\u653E\u5931\u6557",analyzingSpectrogram:"\u5206\u6790\u983B\u8B5C\u5716\u4E2D",frequencyBand0To250:"0-250",frequencyBand250To500:"250-500",frequencyBand500To1k:"0.5-1k",frequencyBand1To2k:"1-2k",frequencyBand2To4k:"2-4k",frequencyBand4To8k:"4-8k",frequencyBand8kPlus:"8k+",pad:"pad",hop:"hop",initializationFailed:"AudioLens \u521D\u59CB\u5316\u5931\u6557",trackGain:"\u589E\u76CA",trackPan:"\u8072\u9053\u5E73\u8861",panLeft:"\u5DE6",panRight:"\u53F3",panCenter:"\u4E2D",doubleClickReset:"\u96D9\u64CA\u91CD\u8A2D",freqScaleMenuTitle:"\u8A72\u901A\u9053\u983B\u7387\u523B\u5EA6",restoreChannelDefault:"\u6062\u5FA9\u8A72\u901A\u9053\u9810\u8A2D",helpAxisGroup:"\u7E31\u5411\u5EA7\u6A19\u8EF8",helpAxisZoom:"\u5EA7\u6A19\u8EF8\u4E0A Ctrl+\u6EFE\u8F2A / \u634F\u5408\uFF1A\u7E2E\u653E\u8A72\u8EF8\uFF08\u6BCF\u901A\u9053\uFF09",helpAxisPan:"\u5EA7\u6A19\u8EF8\u4E0A Shift+\u6EFE\u8F2A / \u6A6B\u5411\u6ED1\u52D5\uFF1A\u5E73\u79FB\u8A72\u8EF8\uFF08\u6BCF\u901A\u9053\uFF09",helpAxisAlt:"\u6CE2\u5F62\u5716\u4E0A Alt+\u6EFE\u8F2A\uFF1A\u7E2E\u653E\u8A72\u901A\u9053\u632F\u5E45",helpAxisScaleMenu:"\u983B\u7387\u8EF8\u53F3\u9375\uFF1A\u8A2D\u5B9A\u8A72\u901A\u9053\u523B\u5EA6\u985E\u578B",helpAxisReset:"\u5EA7\u6A19\u8EF8\u96D9\u64CA\uFF1A\u6062\u5FA9\u8A72\u901A\u9053\u9810\u8A2D"};var ra={"zh-CN":rt,"zh-TW":ot,en:me,ja:Ye,ko:Qe,fr:Ke,de:_e,ru:nt,es:Ze,it:Xe,pt:at,id:$e,no:et,nl:Je,pl:tt,tr:it,vi:st};function pe(n){return{...me,...ra[n]??{}}}function oa(n){let e=(n||"en").toLowerCase();return e==="zh-tw"||e==="zh-hk"||e==="zh-hant"||e.startsWith("zh-hant")?"zh-TW":e==="zh-cn"||e==="zh-sg"||e==="zh-hans"||e.startsWith("zh")?"zh-CN":e.startsWith("ja")?"ja":e.startsWith("ko")?"ko":e.startsWith("fr")?"fr":e.startsWith("de")?"de":e.startsWith("ru")?"ru":e.startsWith("es")?"es":e.startsWith("it")?"it":e.startsWith("pt")?"pt":e.startsWith("id")?"id":e.startsWith("no")||e.startsWith("nb")||e.startsWith("nn")?"no":e.startsWith("nl")?"nl":e.startsWith("pl")?"pl":e.startsWith("tr")?"tr":e.startsWith("vi")?"vi":"en"}function lt(n,e){return n&&n!=="auto"?n:oa(e)}function he(n){return n!==void 0&&Number.isFinite(n)&&n>=3e3&&n<=768e3}function V(n){switch(n){case"signed-8":return{bitDepth:8,sampleFormat:"signed-int",endianness:"none"};case"signed-16":return{bitDepth:16,sampleFormat:"signed-int",endianness:"little"};case"signed-24":return{bitDepth:24,sampleFormat:"signed-int",endianness:"little"};case"signed-32":return{bitDepth:32,sampleFormat:"signed-int",endianness:"little"};case"unsigned-8":return{bitDepth:8,sampleFormat:"unsigned-int",endianness:"none"};case"float-64":return{bitDepth:64,sampleFormat:"float",endianness:"little"};default:return{bitDepth:32,sampleFormat:"float",endianness:"little"}}}function G(n){return n.sampleFormat==="float"?n.bitDepth===64?"float-64":"float-32":n.sampleFormat==="unsigned-int"?"unsigned-8":n.bitDepth===8?"signed-8":n.bitDepth===24?"signed-24":n.bitDepth===32?"signed-32":"signed-16"}var la=3e3;function fe(n,e){let t=n[0]?.length??0;return{channels:n,sampleRate:e,length:t,numberOfChannels:n.length,duration:e>0?t/e:0}}function $(n){return{channels:Array.from({length:n.numberOfChannels},(t,a)=>n.getChannelData(a)),sampleRate:n.sampleRate,length:n.length,numberOfChannels:n.numberOfChannels,duration:n.duration}}function ge(n,e){let t=ct(e),a=ca(n,t),i=ke(t),s=dt(t);if(i<=0||s<=0||a.byteLength%s!==0)throw new Error("PCM parameters do not match the file size.");let o=a.byteLength/s,r=Array.from({length:e.channels},()=>new Float32Array(o));for(let l=0;l<o;l+=1){let d=l*s;for(let c=0;c<e.channels;c+=1){let u=d+c*i;r[c][l]=ua(a,u,t)}}return{sampleRate:e.sampleRate,channels:r}}function da(n,e,t=la){if(e>=t||e<=0||n.length===0)return{channels:n,sampleRate:e};let a=Math.ceil(t/e),i=e*a,s=n[0]?.length??0,o=s*a;return{channels:n.map(l=>{let d=new Float32Array(o);for(let c=0;c<s;c+=1){let u=l[c],p=c+1<s?l[c+1]:u,f=c*a;for(let g=0;g<a;g+=1)d[f+g]=u+(p-u)*g/a}return d}),sampleRate:i}}function be(n,e){let t=da(e.channels,e.sampleRate),a=t.channels[0]?.length??0,i=n.createBuffer(Math.max(1,t.channels.length),Math.max(1,a),t.sampleRate);return t.channels.forEach((s,o)=>i.getChannelData(o).set(s)),i}function ye(n,e){let t=ct(e),a=e.startOffsetBytes??0;if(!he(e.sampleRate))return"PCM sample rate must be between 3000 and 768000 Hz.";if(!Number.isInteger(e.channels)||e.channels<=0||e.channels>32)return"PCM channel count must be between 1 and 32.";if(![8,16,24,32,64].includes(t.bitDepth))return"PCM encoding must be Signed 8/16/24/32-bit PCM, Unsigned 8-bit PCM, 32-bit float, or 64-bit float.";if(t.sampleFormat==="float"&&t.bitDepth!==32&&t.bitDepth!==64)return"Float PCM supports 32-bit or 64-bit only.";if(t.sampleFormat==="unsigned-int"&&t.bitDepth!==8)return"Unsigned PCM currently supports 8-bit only.";if(t.bitDepth>8&&t.endianness==="none")return"Byte order is required for multi-byte PCM encodings.";if(!Number.isInteger(a)||a<0)return"PCM start offset must be a non-negative integer.";if(a>=n.byteLength)return`PCM start offset ${a} bytes exceeds the file size.`;let i=n.byteLength-a,s=dt(t);if(s<=0||i%s!==0)return`Data size after offset (${i} bytes) is not aligned to the current PCM parameters.`}function ca(n,e){return n.subarray(e.startOffsetBytes??0)}function ua(n,e,t){let a=new DataView(n.buffer,n.byteOffset+e,ke(t));if(t.sampleFormat==="float"){let i=t.endianness==="little";return pa(t.bitDepth===64?a.getFloat64(0,i):a.getFloat32(0,i),-1,1)}if(t.bitDepth===8)return t.sampleFormat==="unsigned-int"?(a.getUint8(0)-128)/128:a.getInt8(0)/128;if(t.bitDepth===16)return a.getInt16(0,t.endianness==="little")/32768;if(t.bitDepth===24){let s=t.endianness==="little"?a.getUint8(0)|a.getUint8(1)<<8|a.getUint8(2)<<16:a.getUint8(2)|a.getUint8(1)<<8|a.getUint8(0)<<16;return ma(s)/8388608}return a.getInt32(0,t.endianness==="little")/2147483648}function ma(n){return n&8388608?n|-16777216:n}function ke(n){return n.bitDepth/8}function dt(n){return ke(n)*n.channels}function pa(n,e,t){return Math.max(e,Math.min(t,n))}function ct(n){let e=G(n),t=V(e),a=t.bitDepth===8?"none":n.endianness==="none"?t.endianness:n.endianness;return{...n,...t,endianness:a}}function ut(n,e){return n!==2?0:e===0?-1:e===1?1:0}function mt(n){return n.innerHTML=`
  ...
  `,document.head.appendChild(n)}var Fe=document.querySelector("#app");if(!Fe)throw new Error("AudioLens root element missing");zt();var Te=acquireVsCodeApi();try{let n=new ae(Te,mt(Fe));window.addEventListener("message",e=>{n.handleMessage(e.data)}),Te.postMessage({type:"ready"})}catch(n){let e=n instanceof Error?n.message:String(n);Fe.textContent=`AudioLens initialization failed: ${e}`,Te.postMessage({type:"showError",message:`AudioLens initialization failed: ${e}`})}})();
